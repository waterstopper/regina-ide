...
(function(root, factory) {
    if (typeof define === 'function' && define.amd)
        ...
        if (typeof kotlin_kotlin === 'undefined') {
            throw new Error("Error loading module 'regina_interpreter'. Its dependency 'kotlin_kotlin' was not found. Please, check whether 'kotlin_kotlin' is loaded prior to 'regina_interpreter'.");
        }
        root.regina_interpreter = factory(typeof regina_interpreter === 'undefined' ? {} : regina_interpreter, kotlin_kotlin);
    }
    ...
    var IndexOutOfBoundsException = kotlin_kotlin.$crossModule$.IndexOutOfBoundsException;
    ...
    TokenExpectedTypeException.prototype = Object.create(SyntaxException.prototype);
    TokenExpectedTypeException.prototype.constructor = TokenExpectedTypeException;
    ExpectedTypeException.prototype = Object.create(PositionalException.prototype);
    ...
    Logger.prototype.addWarning_wjr273_k$ = function(token, message) {
        return this.warnings_1.add_1j60pz_k$(new Triple(token._get_position__3188952002_iahqv2_k$()._get_first__3232921377_hkbbvj_k$(), token._get_position__3188952002_iahqv2_k$()._get_second__4255435031_njbah_k$(), message));
    };
    Logger.$metadata$ = {
        simpleName: 'Logger',
        kind: 'object',
    ...
    function main() {
        evaluateJS = (arg) => Evaluation_getInstance().eval_6yi0cr_k$(arg[0], toList(arg).subList_d153ha_k$(1, arg.length));
    ...
    function Optional_init_$Create$(value, isGood, $mask0, $marker) {
        return Optional_init_$Init$(value, isGood, $mask0, $marker, Object.create(Optional.prototype));
    }
    ...
    Optional.prototype.toString = function() {
        return 'Optional(value=' + toString(this.value_1) + ', isGood=' + this.isGood_1 + ')';
    };
    ...
    Optional.prototype.equals = function(other) {
        ...
        var tmp0_other_with_cast = other instanceof Optional ? other : THROW_CCE();
        if (!equals(this.value_1, tmp0_other_with_cast.value_1))
            return false;
        if (!(this.isGood_1 === tmp0_other_with_cast.isGood_1))
            return false;
        return true;
    };
    Optional.$metadata$ = {
    ...
    Tuple4.prototype.toString = function() {
        return 'Tuple4(first=' + this.first_1 + ', second=' + this.second_1 + ', third=' + this.third_1 + ', fourth=' + this.fourth_1 + ')';
    };
    Tuple4.prototype.hashCode = function() {
        ...
        result = imul(result, 31) + (this.fourth_1 == null ? 0 : hashCode(this.fourth_1)) | 0;
        return result;
    };
    Tuple4.prototype.equals = function(other) {
        ...
        var tmp0_other_with_cast = other instanceof Tuple4 ? other : THROW_CCE();
        ...
        if (!equals(this.third_1, tmp0_other_with_cast.third_1))
            return false;
        if (!equals(this.fourth_1, tmp0_other_with_cast.fourth_1))
            return false;
        return true;
    };
    Tuple4.$metadata$ = {
    ...
    Evaluation.prototype.eval_6yi0cr_k$ = function(code, roots) {
        ...
        var tmp = fileTable.getMain_18urbl_k$()._get_body__793495785_d4fd9l_k$();
        tmp.evaluate_hfj3qo_k$(SymbolTable_init_$Create$(null, null, fileTable, false, 3, null));
        Unit_getInstance();
    };
    Evaluation.$metadata$ = {
    ...
    function FunctionFactory$initializeEmbedded$lambda_0() {
        return function(token, args) {
            var tmp = toString_0(FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'x', args));
            throw PositionalException_init_$Create$(tmp, token, null, 0, null, 28, null);
        };
    }
    ...
    function FunctionFactory$initializeEmbedded$lambda_2() {
        return function(token, args) {
            var fileName = FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'path', args);
            Unit_getInstance();
            var content = FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'content', args);
            Unit_getInstance();
            var tmp;
            var tmp_0;
            ...
            if (tmp_0) {
                ...
                throw ExpectedTypeException_init_$Create$(tmp_1, token, null, false, 12, null);
            } else {}
            FileSystem_getInstance().write_kwtaoc_k$(fileName.getPValue_berniv_k$(), content.getPValue_berniv_k$());
            Unit_getInstance();
            return Unit_getInstance();
        };
    }
    ...
    function FunctionFactory$initializeEmbedded$lambda_3() {
        return function(token, args) {
            ...
            if (!(fileName instanceof PString)) {
                ...
                throw ExpectedTypeException_init_$Create$(tmp_0, token, null, false, 12, null);
            } else {}
            return FileSystem_getInstance().read_bwmtyj_k$(fileName.getPValue_berniv_k$());
        };
    }
    ...
    function FunctionFactory$initializeEmbedded$lambda_4() {
        return function(token, args) {
            ...
            return Utils_getInstance().toInt_1vsdtk_k$(FileSystem_getInstance().exists_9c3km3_k$(fileName.getPValue_berniv_k$()));
        };
    }
    ...
    function FunctionFactory$initializeEmbedded$lambda_5() {
        return function(token, args) {
            ...
            return Utils_getInstance().toInt_1vsdtk_k$(FileSystem_getInstance().delete_47x42e_k$(fileName.getPValue_berniv_k$()));
        };
    }

    function FunctionFactory$initializeEmbedded$lambda_6() {
        return function(token, args) {
            var ident = FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'x', args);
            Unit_getInstance();
            var tmp;
            var tmp_0;
            ...
            if (tmp_0) {
                throw PositionalException_init_$Create$('test failed', token, null, 0, null, 28, null);
            } else {}
            return Unit_getInstance();
        };
    }
    ...
    function FunctionFactory$initializeEmbedded$lambda_8() {
        return function(token, args) {
            var seed = FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'x', args);
            Unit_getInstance();
            var tmp;
            ...
            FunctionFactory_getInstance().randomSeed_1 = seed.getPValue_berniv_k$();
            Unit_getInstance();
            FunctionFactory_getInstance().rnd_1 = Random(FunctionFactory_getInstance().randomSeed_1);
            Unit_getInstance();
            Unit_getInstance();
            return Unit_getInstance();
        };
    ...
    function FunctionFactory$initializeEmbedded$lambda_9() {
        return function(token, args) {
            return toString_0(FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'x', args));
        };
    }

    function FunctionFactory$initializeEmbedded$lambda_10() {
        return function(token, args) {
            var argument = FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'x', args);
            var tmp;
            if (argument instanceof PDouble) {
                ...
                if (argument instanceof PInt) {
                    ...
                    if (argument instanceof PString) {
                        ...
                        {
                            throw PositionalException_init_$Create$('cannot cast type to integer', token, null, 0, null, 28, null);
                        }
                    }
                }
            }
            ...
            if (argument instanceof PDouble) {
                ...
                if (argument instanceof PInt) {
                    ...
                    if (argument instanceof PString) {
                        ...
                        {
                            throw PositionalException_init_$Create$('cannot cast type to double', token, null, 0, null, 28, null);
                        }
                    }
                }
            }
        ...
        return function(token, args) {
            ...
            if (argument instanceof PDictionary) {
                ...
                $l$block_2: {
                    ...
                    var tmp$ret$2;
                    $l$block_1: {
                        var tmp0_mapTo_0_1 = ArrayList_init_$Create$_0(tmp0_map_0._get_size__809037418_ddoh9m_k$());
                        var tmp$ret$0;
                        $l$block: {
                            tmp$ret$0 = tmp0_map_0._get_entries__31877249_iz8n5_k$().iterator_jk1svi_k$();
                            break $l$block;
                        }
                ...
                if (argument instanceof PString) {
                    ...
                    $l$block_5: {
                        ...
                        var tmp$ret$5;
                        $l$block_4: {
                            var tmp0_mapTo_0_1_0 = ArrayList_init_$Create$_0(charSequenceLength(tmp1_map_0));
                            var indexedObject = tmp1_map_0;
                            var inductionVariable = 0;
                            var last = indexedObject.length;
                            while (inductionVariable < last) {
                                var item_2_3_0 = charSequenceGet(indexedObject, inductionVariable);
                    ...
                    {
                        throw PositionalException_init_$Create$('cannot cast type to array', token, null, 0, null, 28, null);
                    }
                }
            }
            return tmp;
    ...
    function FunctionFactory$initializeEmbedded$lambda_13() {
        return function(token, args) {
            var argument = FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'angle', args);
            var tmp;
            if (argument instanceof PInt) {
                var tmp$ret$0;
                $l$block: {
                ...
                if (argument instanceof PDouble) {
                    ...
                    {
                        throw PositionalException_init_$Create$('Expected number', token, null, 0, null, 28, null);
                    }
                }
            }
            return tmp;
    ...
    function FunctionFactory$initializeEmbedded$lambda_15() {
        return function(token, args) {
            var argument = FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'number', args);
            var tmp;
            if (argument instanceof PInt) {
                var tmp$ret$0;
                $l$block: {
    ...
    function FunctionFactory$initializeEmbedded$lambda_16() {
        return function(token, args) {
            var argument = FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'sin', args);
            var tmp;
            if (argument instanceof PInt) {
                var tmp$ret$0;
                $l$block: {
    ...
    function FunctionFactory$initializeEmbedded$lambda_17() {
        return function(token, args) {
            var argument = FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'cos', args);
            var tmp;
            if (argument instanceof PInt) {
                var tmp$ret$0;
                $l$block: {
    ...
    function FunctionFactory$initializeEmbedded$lambda_18() {
        return function(token, args) {
            var first = numberToDouble(FunctionFactory_getInstance().getNumber_htzifw_k$(token, 'first', args).getPValue_berniv_k$());
            Unit_getInstance();
            var second = numberToDouble(FunctionFactory_getInstance().getNumber_htzifw_k$(token, 'second', args).getPValue_berniv_k$());
            Unit_getInstance();
            var epsilon = numberToDouble(FunctionFactory_getInstance().getNumber_htzifw_k$(token, 'epsilon', args).getPValue_berniv_k$());
            Unit_getInstance();
            var absTh = numberToDouble(FunctionFactory_getInstance().getNumber_htzifw_k$(token, 'absTh', args).getPValue_berniv_k$());
            Unit_getInstance();
            var tmp;
            if (first === second) {
                tmp = new PInt(1, null);
                ...
                $l$block_2: {
                    ...
                    var tmp2_min_0 = FloatCompanionObject_getInstance()._get_MAX_VALUE__3201573499_i2z81x_k$();
    ...
    FunctionFactory.prototype.createFunction_29w3jx_k$ = function(node) {
        if (!(node._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$() === '(')) {
            var tmp = node._get_left__802434852_d9qyp0_k$();
            throw PositionalException_init_$Create$('Expected parentheses after function name', tmp, null, 0, null, 28, null);
        }
        var tmp$ret$0;
        $l$block: {
            tmp$ret$0 = ArrayList_init_$Create$();
        ...
        var last = _get_lastIndex__339712501(node._get_left__802434852_d9qyp0_k$()._get_children__1387553196_my42wc_k$());
        if (inductionVariable <= last)
            do {
                var i = inductionVariable;
                inductionVariable = inductionVariable + 1 | 0;
                var tmp_0 = node._get_left__802434852_d9qyp0_k$()._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(i);
                if (!(tmp_0 instanceof Assignment)) {
                    var tmp_1 = node._get_left__802434852_d9qyp0_k$()._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(i);
                    withoutDefault.add_1j60pz_k$(tmp_1 instanceof Identifier ? tmp_1 : THROW_CCE());
                    Unit_getInstance();
                } else {
                    {
                        var tmp_2 = node._get_left__802434852_d9qyp0_k$()._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(i);
                        withDefault.add_1j60pz_k$(tmp_2 instanceof Assignment ? tmp_2 : THROW_CCE());
                        Unit_getInstance();
                    }
                }
            }
            while (!(i === last));
        return new RFunction(node._get_left__802434852_d9qyp0_k$()._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$(), withoutDefault, withDefault, node._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(1));
    };
    ...
    FunctionFactory.prototype.getDictionary_8h2ghd_k$ = function(node, name, args) {
        var dictionary = this.getIdent_dfe2u9_k$(node, name, args);
        if (!(dictionary instanceof PDictionary)) {
            var tmp = 'Expected array as ' + name;
            throw PositionalException_init_$Create$(tmp, node, null, 0, null, 28, null);
        } else {}
        return dictionary;
    };
    ...
    FunctionFactory.prototype.getString_j9m6y4_k$ = function(node, name, args) {
    ...
    FunctionFactory.prototype.getNumber_htzifw_k$ = function(node, name, args) {
    ...
    FunctionFactory.prototype.initializeEmbedded_2qlyva_k$ = function() {
        ...
        var res = tmp$ret$0; {
            var tmp = listOf('x');
            var tmp0_set_0 = EmbeddedFunction_init_$Create$('log', tmp, null, FunctionFactory$initializeEmbedded$lambda(), 4, null);
            res.put_3mhbri_k$('log', tmp0_set_0);
            Unit_getInstance();
        } {
            var tmp_0 = listOf('x');
            var tmp1_set_0 = EmbeddedFunction_init_$Create$('except', tmp_0, null, FunctionFactory$initializeEmbedded$lambda_0(), 4, null);
            ...
            var tmp_1 = tmp$ret$1;
            var tmp2_set_0 = EmbeddedFunction_init_$Create$('input', tmp_1, null, FunctionFactory$initializeEmbedded$lambda_1(), 4, null);
            res.put_3mhbri_k$('input', tmp2_set_0);
            Unit_getInstance();
        } {
            var tmp_2 = listOf_0(['content', 'path']);
            var tmp3_set_0 = EmbeddedFunction_init_$Create$('write', tmp_2, null, FunctionFactory$initializeEmbedded$lambda_2(), 4, null);
            res.put_3mhbri_k$('write', tmp3_set_0);
            Unit_getInstance();
        } {
            var tmp_3 = listOf('path');
            var tmp4_set_0 = EmbeddedFunction_init_$Create$('read', tmp_3, null, FunctionFactory$initializeEmbedded$lambda_3(), 4, null);
            res.put_3mhbri_k$('read', tmp4_set_0);
            Unit_getInstance();
        } {
            var tmp_4 = listOf('path');
            var tmp5_set_0 = EmbeddedFunction_init_$Create$('exists', tmp_4, null, FunctionFactory$initializeEmbedded$lambda_4(), 4, null);
            res.put_3mhbri_k$('exists', tmp5_set_0);
            Unit_getInstance();
        } {
            var tmp_5 = listOf('path');
            var tmp6_set_0 = EmbeddedFunction_init_$Create$('delete', tmp_5, null, FunctionFactory$initializeEmbedded$lambda_5(), 4, null);
            res.put_3mhbri_k$('delete', tmp6_set_0);
            Unit_getInstance();
        } {
            var tmp_6 = listOf('x');
            var tmp7_set_0 = EmbeddedFunction_init_$Create$('test', tmp_6, null, FunctionFactory$initializeEmbedded$lambda_6(), 4, null);
            ...
            var tmp_7 = tmp$ret$2;
            var tmp8_set_0 = EmbeddedFunction_init_$Create$('rnd', tmp_7, null, FunctionFactory$initializeEmbedded$lambda_7(), 4, null);
            res.put_3mhbri_k$('rnd', tmp8_set_0);
            Unit_getInstance();
        } {
            var tmp_8 = listOf('x');
            var tmp9_set_0 = EmbeddedFunction_init_$Create$('seed', tmp_8, null, FunctionFactory$initializeEmbedded$lambda_8(), 4, null);
            res.put_3mhbri_k$('seed', tmp9_set_0);
            Unit_getInstance();
        } {
            var tmp_9 = listOf('x');
            var tmp10_set_0 = EmbeddedFunction_init_$Create$('str', tmp_9, null, FunctionFactory$initializeEmbedded$lambda_9(), 4, null);
            res.put_3mhbri_k$('str', tmp10_set_0);
            Unit_getInstance();
        } {
            var tmp_10 = listOf('x');
            var tmp11_set_0 = EmbeddedFunction_init_$Create$('int', tmp_10, null, FunctionFactory$initializeEmbedded$lambda_10(), 4, null);
            res.put_3mhbri_k$('int', tmp11_set_0);
            Unit_getInstance();
        } {
            var tmp_11 = listOf('x');
            var tmp12_set_0 = EmbeddedFunction_init_$Create$('double', tmp_11, null, FunctionFactory$initializeEmbedded$lambda_11(), 4, null);
            res.put_3mhbri_k$('double', tmp12_set_0);
            Unit_getInstance();
        } {
            var tmp_12 = listOf('x');
            var tmp13_set_0 = EmbeddedFunction_init_$Create$('array', tmp_12, null, FunctionFactory$initializeEmbedded$lambda_12(), 4, null);
            res.put_3mhbri_k$('array', tmp13_set_0);
            Unit_getInstance();
        } {
            var tmp_13 = listOf('angle');
            var tmp14_set_0 = EmbeddedFunction_init_$Create$('sin', tmp_13, null, FunctionFactory$initializeEmbedded$lambda_13(), 4, null);
            res.put_3mhbri_k$('sin', tmp14_set_0);
            Unit_getInstance();
        } {
            var tmp_14 = listOf('angle');
            var tmp15_set_0 = EmbeddedFunction_init_$Create$('cos', tmp_14, null, FunctionFactory$initializeEmbedded$lambda_14(), 4, null);
            res.put_3mhbri_k$('cos', tmp15_set_0);
            Unit_getInstance();
        } {
            var tmp_15 = listOf('number');
            var tmp16_set_0 = EmbeddedFunction_init_$Create$('sqrt', tmp_15, null, FunctionFactory$initializeEmbedded$lambda_15(), 4, null);
            res.put_3mhbri_k$('sqrt', tmp16_set_0);
            Unit_getInstance();
        } {
            var tmp_16 = listOf('sin');
            var tmp17_set_0 = EmbeddedFunction_init_$Create$('asin', tmp_16, null, FunctionFactory$initializeEmbedded$lambda_16(), 4, null);
            res.put_3mhbri_k$('asin', tmp17_set_0);
            Unit_getInstance();
        } {
            var tmp_17 = listOf('cos');
            var tmp18_set_0 = EmbeddedFunction_init_$Create$('acos', tmp_17, null, FunctionFactory$initializeEmbedded$lambda_17(), 4, null);
            res.put_3mhbri_k$('acos', tmp18_set_0);
            Unit_getInstance();
        } {
            var tmp_18 = listOf_0(['first', 'second']);
            var tmp_19 = listOf_0(['epsilon = 0.0000000000000000000000000001', 'absTh = 0.0000001']);
    ...
    function FunctionFactory_getInstance() {
        if (FunctionFactory_instance == null)
            new FunctionFactory();
    ...
    function addDeclarationsToFileTable($this, fileTable, nodes) {
        ...
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            ...
            if (tmp1_subject instanceof ImportNode)
                fileTable.addImport_wgtzok_k$(node, getFileTableByName($this, PathBuilder_getInstance().getFullPath_tjb74u_k$(node._get_fileName__149290628_2gvtdw_k$(), $this.roots_1)));
            else {
                if (tmp1_subject instanceof FunctionNode)
                    fileTable.addFunction_5sy9lo_k$(FunctionFactory_getInstance().createFunction_29w3jx_k$(node));
                else {
                    if (tmp1_subject instanceof TypeNode) {
                        var type = fileTable.addType_ye6w96_k$(node); {
                            var tmp0_set_0 = $this.supertypes_1;
                            var tmp1_set_0 = node._get_superTypeNode__300917434_4z5pdm_k$();
    ...
    function getFileTableByName($this, name) {
        if ($this.imports_1.get_1mhr4y_k$(name) == null) {
            ...
            $this.importStack_1.add_1j60pz_k$(ensureNotNull($this.imports_1.get_1mhr4y_k$(name)));
            Unit_getInstance();
        }
    ...
    ImportGraphCreator.prototype._get_visitedTables__1623761026_ququ0y_k$ = function() {
        return this.visitedTables_1;
    };
    ImportGraphCreator.prototype._get_supertypes__1291562605_lcyo31_k$ = function() {
    ...
    ImportGraphCreator.prototype.createGraph_hzqy5d_k$ = function() {
        ...
        $l$loop: while (true) {
            ...
            Unit_getInstance();
            addDeclarationsToFileTable(this, nextFileTable, PathBuilder_getInstance().getNodes_jwpeo6_k$(nextFileTable._get_fileName__149290628_2gvtdw_k$()));
        }
    };
    ...
    function addTokens($this) {
        $this.nodes_1.add_1j60pz_k$(Token_init_$Create$('fictive', null, null, 0, null, null, null, null, 254, null));
        Unit_getInstance();
        $this.nodes_1.add_1j60pz_k$(createNextToken($this));
        Unit_getInstance();
        while ($this.index_1 < $this.source_1.length)
            addToken($this, createNextToken($this));
        if (!(last($this.nodes_1)._get_symbol__541899891_8ymsmr_k$() === '(EOF)')) {
            var tmp = $this.position_1;
            $this.nodes_1.add_1j60pz_k$(Token_init_$Create$('(EOF)', '(EOF)', tmp, 0, null, null, null, null, 248, null));
            Unit_getInstance();
        }
        if ($this.nodes_1._get_size__809037418_ddoh9m_k$() >= 100000) {
            Logger_getInstance().addWarning_wjr273_k$(last($this.nodes_1), 'File too large');
            Unit_getInstance();
        }
    ...
    function createNextToken($this) {
        ...
        if ($this.index_1 === $this.source_1.length)
            return $this.registry_1.token_x5edt_k$('(EOF)', '(EOF)', $this.position_1);
        if (equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(92)))) {
            var tmp0_this = $this;
            ...
            if (!isLineSeparator($this)) {
                var tmp = $this.position_1;
                throw PositionalException_init_$Create$('Expected new line after \\', null, tmp, 1, null, 18, null);
            } else
                $this.index_1 = moveAfterLineSeparator($this);
            consumeWhitespaceAndComments($this);
            Unit_getInstance();
            $this.position_1 = new Pair(0, $this.position_1._get_second__4255435031_njbah_k$() + 1 | 0);
        }
        var tmp_0;
        if (equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(34)))) {
            tmp_0 = nextString($this);
        } else if (isFirstIdentChar($this, charSequenceGet($this.source_1, $this.index_1))) {
            tmp_0 = nextIdent($this);
        } else if (isDigit(charSequenceGet($this.source_1, $this.index_1))) {
            tmp_0 = nextNumber($this);
        } else if (isOperatorChar($this, charSequenceGet($this.source_1, $this.index_1))) {
            tmp_0 = nextOperator($this);
        } else if (equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(35)))) {
            tmp_0 = nextMeta($this);
        } else {
            var tmp_1 = $this.position_1;
            throw PositionalException_init_$Create$('Invalid character', null, tmp_1, 1, null, 18, null);
        }
        return tmp_0;
    }
    ...
    function nextMeta($this) {
        ...
        while ($this.index_1 < $this.source_1.length ? isIdentChar($this, charSequenceGet($this.source_1, $this.index_1)) : false)
    ...
    function nextString($this) {
        var res = StringBuilder_init_$Create$();
        moveAndAppend($this, res);
        while (!equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(34)))) {
            if (equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(92))) ? $this.source_1.length > ($this.index_1 + 1 | 0) : false) {
                move$default($this, 0, 2, null);
    ...
    function nextIdent($this) {
        ...
        while ($this.index_1 < $this.source_1.length ? isIdentChar($this, charSequenceGet($this.source_1, $this.index_1)) : false)
            moveAndAppend($this, res);
        if ($this.registry_1.defined_x3osmw_k$(res.toString()))
            return $this.registry_1.definedIdentifier_m9xvbe_k$(res.toString(), res.toString(), new Pair($this.position_1._get_first__3232921377_hkbbvj_k$() - res.toString().length | 0, $this.position_1._get_second__4255435031_njbah_k$()));
        return $this.registry_1.identifier_q37um9_k$('(IDENT)', res.toString(), new Pair($this.position_1._get_first__3232921377_hkbbvj_k$() - res.toString().length | 0, $this.position_1._get_second__4255435031_njbah_k$()));
    }

    function nextNumber($this) {
        var res = StringBuilder_init_$Create$();
        moveAndAppend($this, res);
        while ($this.index_1 < $this.source_1.length ? isDigit(charSequenceGet($this.source_1, $this.index_1)) : false)
            moveAndAppend($this, res);
        if ((($this.index_1 + 1 | 0) < $this.source_1.length ? equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(46))) : false) ? isDigit(charSequenceGet($this.source_1, $this.index_1 + 1 | 0)) : false) {
            moveAndAppend($this, res);
            while ($this.index_1 < $this.source_1.length ? isDigit(charSequenceGet($this.source_1, $this.index_1)) : false)
                moveAndAppend($this, res);
        }
        return new TokenNumber(res.toString(), new Pair($this.position_1._get_first__3232921377_hkbbvj_k$() - res.toString().length | 0, $this.position_1._get_second__4255435031_njbah_k$()));
    }
    ...
    function nextOperator($this) {
        ...
        if (last <= inductionVariable)
            do {
                ...
                inductionVariable = inductionVariable + -1 | 0;
                if (ind < $this.source_1.length ? $this.registry_1.defined_x3osmw_k$(substring($this.source_1, numberRangeToNumber($this.index_1, ind))) : false) {
                    var value = substring($this.source_1, numberRangeToNumber($this.index_1, ind));
                    var operator = $this.registry_1.operator_5vquas_k$(value, value, new Pair($this.position_1._get_first__3232921377_hkbbvj_k$() - value.length | 0, $this.position_1._get_second__4255435031_njbah_k$()));
                    if (operator._get_symbol__541899891_8ymsmr_k$() === '(SEP)' ? !(operator._get_value__3683422336_a43j40_k$() === ';') : false) {
                        toNextLine($this);
                    } else {
            ...
            while (!(ind === last));
        var tmp = $this.position_1;
        throw PositionalException_init_$Create$('Invalid operator', null, tmp, 0, null, 26, null);
    }
    ...
    function consumeWhitespaceAndComments($this) {
        ...
        while (whitespace ? true : comments) {
            ...
            if (comments)
                addToken($this, $this.registry_1.token_x5edt_k$('(SEP)', '//', $this.position_1));
            var tmp1 = iter;
            iter = tmp1 + 1 | 0;
            Unit_getInstance();
        }
    ...
    function consumeComments($this) {
        if ((($this.index_1 < $this.source_1.length ? equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(47))) : false) ? $this.index_1 < _get_lastIndex__339712501_0($this.source_1) : false) ? equals(new Char(charSequenceGet($this.source_1, $this.index_1 + 1 | 0)), new Char(_Char___init__impl__380027157(47))) : false) {
    ...
    function consumeWhitespace($this) {
        var res = ($this.index_1 < $this.source_1.length ? !isLineSeparator($this) : false) ? isWhitespace(charSequenceGet($this.source_1, $this.index_1)) : false;
        while (($this.index_1 < $this.source_1.length ? !isLineSeparator($this) : false) ? isWhitespace(charSequenceGet($this.source_1, $this.index_1)) : false) {
            move$default($this, 0, 2, null);
        }
        return res;
    }
    ...
    function isLineSeparator($this) {
        if ($this.index_1 === _get_lastIndex__339712501_0($this.source_1))
            return equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(13))) ? true : equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(10)));
        if (equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(13))) ? equals(new Char(charSequenceGet($this.source_1, $this.index_1 + 1 | 0)), new Char(_Char___init__impl__380027157(10))) : false)
            return true;
        return equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(13))) ? true : equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(10)));
    }
    ...
    function moveAfterLineSeparator($this) {
        if ($this.index_1 === _get_lastIndex__339712501_0($this.source_1))
            return (equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(13))) ? true : equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(10)))) ? $this.index_1 + 1 | 0 : $this.index_1;
        if (equals(new Char(charSequenceGet($this.source_1, $this.index_1)), new Char(_Char___init__impl__380027157(13))) ? equals(new Char(charSequenceGet($this.source_1, $this.index_1 + 1 | 0)), new Char(_Char___init__impl__380027157(10))) : false)
    ...
    function addToken($this, newNode) {
        if (!(last($this.nodes_1)._get_symbol__541899891_8ymsmr_k$() === '(SEP)') ? true : !(newNode._get_symbol__541899891_8ymsmr_k$() === '(SEP)')) {
    ...
    function move($this, step) {
        ...
        $this.position_1 = new Pair($this.position_1._get_first__3232921377_hkbbvj_k$() + step | 0, $this.position_1._get_second__4255435031_njbah_k$());
    }
    ...
    function isFirstIdentChar($this, c) {
        return isLetter(c) ? true : equals(new Char(c), new Char(_Char___init__impl__380027157(95)));
    }

    function isIdentChar($this, c) {
        return isLetterOrDigit(c) ? true : equals(new Char(c), new Char(_Char___init__impl__380027157(95)));
    }
    ...
    function Lexer() {
        this.source_1 = '';
        this.operators_1 = '!@$%^*-+=?.,:;"&|/(){}[]><\n\r';
        this.escapes_1 = mutableMapOf([to(new Char(_Char___init__impl__380027157(34)), new Char(_Char___init__impl__380027157(34))), to(new Char(_Char___init__impl__380027157(92)), new Char(_Char___init__impl__380027157(92))), to(new Char(_Char___init__impl__380027157(98)), new Char(_Char___init__impl__380027157(8))), to(new Char(_Char___init__impl__380027157(110)), new Char(_Char___init__impl__380027157(10))), to(new Char(_Char___init__impl__380027157(114)), new Char(_Char___init__impl__380027157(13))), to(new Char(_Char___init__impl__380027157(116)), new Char(_Char___init__impl__380027157(9)))]);
    ...
    Lexer.prototype.next_20eer_k$ = function() {
        $l$loop: while (true) {
            ...
            if (!(this.nodes_1.get_fkrdnv_k$(tmp0_this.tokenIndex_1)._get_symbol__541899891_8ymsmr_k$() === '(SEP)')) {
                break $l$loop;
            }
        }
    ...
    Lexer.prototype.moveAfterSeparator_c34j3r_k$ = function() {
        ...
        Unit_getInstance();
        if (!(this.nodes_1.get_fkrdnv_k$(this.tokenIndex_1)._get_symbol__541899891_8ymsmr_k$() === '(SEP)') ? !(this.nodes_1.get_fkrdnv_k$(this.tokenIndex_1)._get_symbol__541899891_8ymsmr_k$() === '(EOF)') : false) {
            var tmp = this.nodes_1.get_fkrdnv_k$(this.tokenIndex_1);
            throw SyntaxException_init_$Create$('Expected separator', tmp, null, 4, null);
        }
    };
    Lexer.prototype.peek_21nx7_k$ = function() {
        var offset = 1;
        if ((this.tokenIndex_1 + offset | 0) > _get_lastIndex__339712501(this.nodes_1))
            return last(this.nodes_1);
        while (this.nodes_1.get_fkrdnv_k$(this.tokenIndex_1 + offset | 0)._get_symbol__541899891_8ymsmr_k$() === '(SEP)') {
            var tmp0 = offset;
            offset = tmp0 + 1 | 0;
            Unit_getInstance();
        }
    ...
    Lexer.prototype.peekSeparator_78d6tm_k$ = function() {
        return this.nodes_1.get_fkrdnv_k$(this.tokenIndex_1 + 1 | 0)._get_symbol__541899891_8ymsmr_k$() === '(SEP)';
    };
    Lexer.$metadata$ = {
        simpleName: 'Lexer',
        kind: 'class',
    ...
    Parser.prototype.statements_3k22vw_k$ = function() {
        ...
        while (!(next._get_symbol__541899891_8ymsmr_k$() === '(EOF)') ? !(next._get_symbol__541899891_8ymsmr_k$() === '}') : false) {
        ...
        $l$block_2: {
            ...
            $l$block_1: {
                ...
                while (tmp0_iterator_1_2.hasNext_bitz1p_k$()) {
                    ...
                    var tmp$ret$1;
                    $l$block_0: {
                        tmp$ret$1 = !(element_2_3._get_symbol__541899891_8ymsmr_k$() === '(SEP)');
                        break $l$block_0;
                    }
                    if (tmp$ret$1) {
    ...
    Parser.prototype.block_thjbhv_k$ = function(canBeSingleStatement) {
        ...
        if (!(token._get_symbol__541899891_8ymsmr_k$() === '{')) {
            if (canBeSingleStatement) {
                ...
                Unit_getInstance();
                var res = TokenBlock_init_$Create$(new Pair(token._get_position__3188952002_iahqv2_k$()._get_first__3232921377_hkbbvj_k$() - 1 | 0, token._get_position__3188952002_iahqv2_k$()._get_second__4255435031_njbah_k$()));
                res._get_children__1387553196_my42wc_k$().add_1j60pz_k$(this.statement_yhfyq9_k$());
                Unit_getInstance();
                return res;
            }
    ...
    PathBuilder.prototype.getFullPath_tjb74u_k$ = function(importName, roots) {
        ...
        if (tmp0_subject instanceof Link) {
            var res = StringBuilder_init_$Create$();
            var tmp1_iterator = importName._get_children__1387553196_my42wc_k$().iterator_jk1svi_k$();
            while (tmp1_iterator.hasNext_bitz1p_k$()) {
                var child = tmp1_iterator.next_20eer_k$();
                res.append_ssq29y_k$(child._get_value__3683422336_a43j40_k$() + '/');
                Unit_getInstance();
            }
            tmp = res.deleteAt_w9fbwd_k$(_get_lastIndex__339712501_0(res)).append_ssq29y_k$('.rgn').toString();
        } else {
            {
        ...
        if (candidates.isEmpty_y1axqb_k$()) {
            ...
            if (importName instanceof Link) {
                ...
                tmp_0 = joinToString$default(tmp_1, '/', null, null, 0, null, null, 62, null);
            } else {
                {
            ...
            throw PositionalException_init_$Create$(tmp_2, importName, null, 0, null, 28, null);
        }
        if (candidates._get_size__809037418_ddoh9m_k$() > 1) {
            var tmp_3;
            if (importName instanceof Link) {
                var tmp_4 = importName._get_children__1387553196_my42wc_k$();
                tmp_3 = joinToString$default(tmp_4, '/', null, null, 0, null, null, 62, null);
            } else {
                {
                    tmp_3 = importName._get_value__3683422336_a43j40_k$();
                }
            }
            var tmp_5 = 'Impossible to import ' + tmp_3 + '. Found ' + candidates._get_size__809037418_ddoh9m_k$() + ' files: ';
            var tmp_6 = tmp_5 + joinToString$default(candidates, ', ', null, null, 0, null, null, 62, null);
            throw PositionalException_init_$Create$(tmp_6, importName, null, 0, null, 28, null);
        }
    ...
    function PathBuilder_getInstance() {
        if (PathBuilder_instance == null)
            new PathBuilder();
        return PathBuilder_instance;
    }

    function PositionalException_init_$Init$(errorMessage, node, position, length, file, $mask0, $marker, $this) {
        if (!(($mask0 & 2) === 0)) {
        ...
        if (!(($mask0 & 16) === 0))
            file = '';
        PositionalException.call($this, errorMessage, node, position, length, file);
        return $this;
    }

    function PositionalException_init_$Create$(errorMessage, node, position, length, file, $mask0, $marker) {
        var tmp = PositionalException_init_$Init$(errorMessage, node, position, length, file, $mask0, $marker, Object.create(PositionalException.prototype));
    ...
    PositionalException.prototype._get_message__1663917034_rinilm_k$ = function() {
        return '`' + this.node_1._get_value__3683422336_a43j40_k$() + '` ' + this.errorMessage_1 + ' at ' + this.getPosition_oardy9_k$();
    };
    PositionalException.prototype.getPosition_oardy9_k$ = function() {
        return !(this.node_1._get_value__3683422336_a43j40_k$() === '') ? '' + this.node_1._get_position__3188952002_iahqv2_k$()._get_second__4255435031_njbah_k$() + ',' + this.node_1._get_position__3188952002_iahqv2_k$()._get_first__3232921377_hkbbvj_k$() + '-' + ((this.node_1._get_position__3188952002_iahqv2_k$()._get_first__3232921377_hkbbvj_k$() + this.node_1._get_value__3683422336_a43j40_k$().length | 0) - 1 | 0) : '' + this.position_1._get_second__4255435031_njbah_k$() + ',' + this.position_1._get_first__3232921377_hkbbvj_k$() + '-' + ((this.position_1._get_first__3232921377_hkbbvj_k$() + this.length_1 | 0) - 1 | 0);
    };
    ...
    function SyntaxException_init_$Init$(errorMessage, token, position, $mask0, $marker, $this) {
        if (!(($mask0 & 4) === 0))
            position = new Pair(0, 0);
    ...
    function SyntaxException_init_$Create$(errorMessage, token, position, $mask0, $marker) {
        var tmp = SyntaxException_init_$Init$(errorMessage, token, position, $mask0, $marker, Object.create(SyntaxException.prototype));
    ...
    function NotFoundException_init_$Init$(node, fileName, file, variable, $mask0, $marker, $this) {
        if (!(($mask0 & 1) === 0)) {
            node = Node_init_$Create$(null, null, null, null, 15, null);
        }
        if (!(($mask0 & 2) === 0))
    ...
    function NotFoundException_init_$Create$(node, fileName, file, variable, $mask0, $marker) {
        var tmp = NotFoundException_init_$Init$(node, fileName, file, variable, $mask0, $marker, Object.create(NotFoundException.prototype));
        captureStack(tmp, NotFoundException_init_$Create$);
        return tmp;
    }

    function NotFoundException(node, fileName, file, variable) {
        PositionalException_init_$Init$('', node, null, 0, fileName === '' ? file._get_fileName__149290628_2gvtdw_k$() : fileName, 12, null, this);
        this.variable_1 = variable;
        captureStack(this, NotFoundException);
    }
    NotFoundException.prototype._get_message__1663917034_rinilm_k$ = function() {
        var tmp0_safe_receiver = this.variable_1;
        var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : toString_0(tmp0_safe_receiver);
        return 'Not found ' + (tmp1_elvis_lhs == null ? this._get_node__804577417_db0vwp_k$()._get_value__3683422336_a43j40_k$() : tmp1_elvis_lhs) + (' at ' + this.getPosition_oardy9_k$());
    };
    ...
    function TokenExpectedTypeException_init_$Init$(classes, token, value, expectedMultiple, $mask0, $marker, $this) {
        if (!(($mask0 & 4) === 0))
            value = null;
        if (!(($mask0 & 8) === 0))
            expectedMultiple = false;
        TokenExpectedTypeException.call($this, classes, token, value, expectedMultiple);
        return $this;
    }

    function TokenExpectedTypeException_init_$Create$(classes, token, value, expectedMultiple, $mask0, $marker) {
        var tmp = TokenExpectedTypeException_init_$Init$(classes, token, value, expectedMultiple, $mask0, $marker, Object.create(TokenExpectedTypeException.prototype));
    ...
    function TokenExpectedTypeException$_get_message_$lambda_2941932641(this$0) {
        return function(it) {
            return mapToString(this$0, it);
        };
    }

    function TokenExpectedTypeException(classes, token, value, expectedMultiple) {
    ...
    TokenExpectedTypeException.prototype._get_message__1663917034_rinilm_k$ = function() {
        var tmp = this.expectedMultiple_1 ? ' and ' : ' or ';
        return 'Expected ' + joinToString$default(this.classes_1, tmp, null, null, 0, null, TokenExpectedTypeException$_get_message_$lambda_2941932641(this), 30, null) + (!(this.value_1 == null) ? ', but got ' + mapToString(this, getKClassFromExpression(this.value_1)) : '') + (' ' + this._get_token__3639048440_auim88_k$()._get_position__3188952002_iahqv2_k$());
    };
    ...
    function ExpectedTypeException_init_$Init$(classes, node, value, expectedMultiple, $mask0, $marker, $this) {
        if (!(($mask0 & 4) === 0))
            value = null;
        if (!(($mask0 & 8) === 0))
            expectedMultiple = false;
        ExpectedTypeException.call($this, classes, node, value, expectedMultiple);
        return $this;
    }

    function ExpectedTypeException_init_$Create$(classes, node, value, expectedMultiple, $mask0, $marker) {
        var tmp = ExpectedTypeException_init_$Init$(classes, node, value, expectedMultiple, $mask0, $marker, Object.create(ExpectedTypeException.prototype));
    ...
    function ExpectedTypeException(classes, node, value, expectedMultiple) {
        PositionalException_init_$Init$('', node, null, 0, null, 28, null, this);
        this.classes_1 = classes;
        this.value_1 = value;
        this.expectedMultiple_1 = expectedMultiple;
        captureStack(this, ExpectedTypeException);
    }
    ExpectedTypeException.prototype._get_message__1663917034_rinilm_k$ = function() {
        var tmp = this.expectedMultiple_1 ? ' and ' : ' or ';
        return 'Expected ' + joinToString$default(this.classes_1, tmp, null, null, 0, null, ExpectedTypeException$_get_message_$lambda_2916805064(this), 30, null) + (!(this.value_1 == null) ? ', but got ' + mapToString_0(this, getKClassFromExpression(this.value_1)) : '') + (' ' + this._get_node__804577417_db0vwp_k$()._get_position__3188952002_iahqv2_k$());
    };
    ...
    function register($this, symbol, bp, nud, led, std) {
        if (!($this.table_1.get_1mhr4y_k$(symbol) == null)) {
            ...
            if (!(nud == null) ? value._get_nud__857243828_e6dpkk_k$() == null : false)
                value._set_nud__296131368_4rdm8l_k$(nud);
            if (!(led == null) ? value._get_led__857168870_e6c3qe_k$() == null : false)
                value._set_led__296056410_ll7hoc_k$(led);
            if (!(std == null) ? value._get_std__857391822_e6gvri_k$() == null : false)
                value._set_std__296279362_1k36f9_k$(std);
        } else {
            var tmp0_set_0 = $this.table_1;
            var tmp1_set_0 = Token_init_$Create$(null, null, null, bp, nud, led, std, null, 135, null);
    ...
    function Registry$prefix$lambda() {
        return function(t, p) {
            t._get_children__1387553196_my42wc_k$().add_1j60pz_k$(p.expression_l6myl3_k$(100));
            Unit_getInstance();
            return t;
        };
    }
    ...
    function Registry$unaryMinus$lambda() {
        return function(t, p) {
            ...
            if (tmp_0 instanceof TokenNumber) {
                t._get_left__802434852_d9qyp0_k$()._set_value__1325260276_wbpkyq_k$('-' + t._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$());
    ...
    function Registry$infix$lambda() {
        return function(t, p, left) {
            ...
            Unit_getInstance();
            t._get_children__1387553196_my42wc_k$().add_1j60pz_k$(p.expression_l6myl3_k$(t._get_bindingPower__398781387_6lf9or_k$()));
            Unit_getInstance();
            return t;
        };
    }
    ...
    function Registry$infixRight$lambda() {
        return function(t, p, left) {
            t._get_children__1387553196_my42wc_k$().add_1j60pz_k$(left);
            Unit_getInstance();
            t._get_children__1387553196_my42wc_k$().add_1j60pz_k$(p.expression_l6myl3_k$(t._get_bindingPower__398781387_6lf9or_k$() - 1 | 0));
            Unit_getInstance();
            return t;
        };
    }
    ...
    Registry.prototype.operator_5vquas_k$ = function(symbol, value, position) {
        return TokenFactory_getInstance().createOperator_3irh8_k$(symbol, value, position, ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_bindingPower__398781387_6lf9or_k$(), ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_nud__857243828_e6dpkk_k$(), ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_led__857168870_e6c3qe_k$(), ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_std__857391822_e6gvri_k$());
    };
    Registry.prototype.string_thqtp3_k$ = function(symbol, value, position) {
        return new TokenString(symbol, value, position, ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_bindingPower__398781387_6lf9or_k$(), ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_nud__857243828_e6dpkk_k$(), ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_led__857168870_e6c3qe_k$(), ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_std__857391822_e6gvri_k$());
    };
    Registry.prototype.token_x5edt_k$ = function(symbol, value, position) {
        var tmp = ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_bindingPower__398781387_6lf9or_k$();
        var tmp_0 = ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_nud__857243828_e6dpkk_k$();
        var tmp_1 = ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_led__857168870_e6c3qe_k$();
        var tmp_2 = ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_std__857391822_e6gvri_k$();
        return Token_init_$Create$(symbol, value, position, tmp, tmp_0, tmp_1, tmp_2, null, 128, null);
    };
    ...
    Registry.prototype.definedIdentifier_m9xvbe_k$ = function(symbol, value, position) {
        return TokenFactory_getInstance().createWordToken_g6p633_k$(symbol, value, position, ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_bindingPower__398781387_6lf9or_k$(), ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_nud__857243828_e6dpkk_k$(), ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_led__857168870_e6c3qe_k$(), ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_std__857391822_e6gvri_k$());
    };
    Registry.prototype.identifier_q37um9_k$ = function(symbol, value, position) {
        return new TokenIdentifier(symbol, value, position, ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_bindingPower__398781387_6lf9or_k$(), ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_nud__857243828_e6dpkk_k$(), ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_led__857168870_e6c3qe_k$(), ensureNotNull(this.table_1.get_1mhr4y_k$(symbol))._get_std__857391822_e6gvri_k$());
    };
    Registry.$metadata$ = {
        simpleName: 'Registry',
        kind: 'class',
    ...
    function sequence($this, node, parser) {
        var comma = false;
        while (true) {
            node._get_children__1387553196_my42wc_k$().add_1j60pz_k$(parser.expression_l6myl3_k$(0));
            Unit_getInstance();
            if (!(parser._get_lexer__3401167429_es58e3_k$().peek_21nx7_k$()._get_symbol__541899891_8ymsmr_k$() === ','))
                return comma;
    ...
    function isLinkable($this, node) {
        if (!isInterface(node, Linkable)) {
            var tmp = listOf_0([getKClass(Identifier), getKClass(Invocation), getKClass(Index)]);
            throw TokenExpectedTypeException_init_$Create$(tmp, node, node, false, 8, null);
        } else {}
        var index = node;
        $l$loop: while (true) {
        ...
        if (!isInterface(index, Linkable)) {
            var tmp_0 = listOf_0([getKClass(Identifier), getKClass(Invocation), getKClass(Index)]);
            var tmp_1 = index;
            var tmp_2 = index;
            throw TokenExpectedTypeException_init_$Create$(tmp_0, tmp_1, tmp_2, false, 8, null);
        } else {}
    }

    function checkImportedFolder($this, link) {
        var tmp0_iterator = link._get_children__1387553196_my42wc_k$().iterator_jk1svi_k$();
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            var ident = tmp0_iterator.next_20eer_k$();
            if (!checkIdentifierInImport($this, ident)) {
                throw SyntaxException_init_$Create$('Each folder should be represented as identifier', ident, null, 4, null);
            }
        }
    }
    ...
    function checkIdentifierInImport($this, node) {
        ...
        if (node instanceof TokenIdentifier) {
            ...
            {
                tmp = node._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$() === 0;
            }
        }
        return tmp;
    }
    ...
    function RegistryFactory$getRegistry$lambda() {
        return function(node, _anonymous_parameter_1__2695192083) {
            return new TokenNumber('0', node._get_position__3188952002_iahqv2_k$());
        };
    }

    function RegistryFactory$getRegistry$lambda_0() {
        return function(node, _anonymous_parameter_1__2695192083) {
            return new TokenNumber('1', node._get_position__3188952002_iahqv2_k$());
        };
    }
    ...
    function RegistryFactory$getRegistry$lambda_1() {
        return function(node, parser, left) {
            ...
            Unit_getInstance();
            node._get_children__1387553196_my42wc_k$().add_1j60pz_k$(parser.expression_l6myl3_k$(105));
            Unit_getInstance();
            isLinkable(RegistryFactory_getInstance(), last(node._get_children__1387553196_my42wc_k$()));
    ...
    function RegistryFactory$getRegistry$lambda_2() {
        return function(node, parser, left) {
            var tmp;
            if ((((!(left._get_symbol__541899891_8ymsmr_k$() === '(LINK)') ? !(left._get_symbol__541899891_8ymsmr_k$() === '(IDENT)') : false) ? !(left._get_symbol__541899891_8ymsmr_k$() === '[') : false) ? !(left._get_symbol__541899891_8ymsmr_k$() === '(') : false) ? !(left._get_symbol__541899891_8ymsmr_k$() === '!') : false) {
    ...
    function RegistryFactory$getRegistry$lambda_3() {
        return function(node, parser, left) {
            ...
            if (!(t._get_symbol__541899891_8ymsmr_k$() === ']')) {
                ...
                throw SyntaxException_init_$Create$('Expected index', t, null, 4, null);
            }
            return res;
        };
    }
    ...
    function RegistryFactory$getRegistry$lambda_4() {
        return function(node, parser) {
            ...
            var tmp_0;
            if (comma) {
                throw SyntaxException_init_$Create$('Tuples are not implemented', node, null, 4, null);
            } else if (node._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$() === 0) {
                throw SyntaxException_init_$Create$('Empty parentheses', node, null, 4, null);
            } else {
                tmp_0 = node._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(0);
            }
            return tmp_0;
        };
    }
    ...
    function RegistryFactory$getRegistry$lambda_6() {
        return function(node, parser) {
            ...
            if (!(parser._get_lexer__3401167429_es58e3_k$().peek_21nx7_k$()._get_symbol__541899891_8ymsmr_k$() === '}')) {
                $l$loop: while (true) {
                    res._get_children__1387553196_my42wc_k$().add_1j60pz_k$(parser.expression_l6myl3_k$(0));
                    Unit_getInstance();
                    if (!(last(res._get_children__1387553196_my42wc_k$())._get_symbol__541899891_8ymsmr_k$() === ':')) {
                        var tmp_0 = last(res._get_children__1387553196_my42wc_k$());
                        throw SyntaxException_init_$Create$('Expected key and value', tmp_0, null, 4, null);
                    }
                    if (!(parser._get_lexer__3401167429_es58e3_k$().peek_21nx7_k$()._get_symbol__541899891_8ymsmr_k$() === ','))
                        break $l$loop;
                    parser.advance_fikpbz_k$(',');
    ...
    function RegistryFactory$getRegistry$lambda_8() {
        return function(node, parser) {
            ...
            res._get_children__1387553196_my42wc_k$().add_1j60pz_k$(parser.expression_l6myl3_k$(0));
            Unit_getInstance();
            res._get_children__1387553196_my42wc_k$().add_1j60pz_k$(parser.block_thjbhv_k$(true));
            Unit_getInstance();
            var next = parser._get_lexer__3401167429_es58e3_k$().peek_21nx7_k$();
            Unit_getInstance();
            var tmp;
            if (next._get_value__3683422336_a43j40_k$() === 'else') {
                parser._get_lexer__3401167429_es58e3_k$().next_20eer_k$();
                Unit_getInstance();
                next = parser._get_lexer__3401167429_es58e3_k$().peek_21nx7_k$();
                var tmp_0;
                if (next._get_value__3683422336_a43j40_k$() === 'if') {
                    res._get_children__1387553196_my42wc_k$().add_1j60pz_k$(parser.statement_yhfyq9_k$());
    ...
    function RegistryFactory$getRegistry$lambda_9() {
        return function(node, parser) {
            ...
            Unit_getInstance();
            var tmp;
            if (parser._get_lexer__3401167429_es58e3_k$().peek_21nx7_k$()._get_value__3683422336_a43j40_k$() === 'as') {
                parser.advance_fikpbz_k$('as');
                Unit_getInstance();
                res._get_children__1387553196_my42wc_k$().add_1j60pz_k$(parser.expression_l6myl3_k$(0));
                Unit_getInstance();
                var tmp_0;
                if (!checkIdentifierInImport(RegistryFactory_getInstance(), res._get_right__3576132917_bvz45n_k$())) {
                    var tmp_1 = res._get_right__3576132917_bvz45n_k$();
                    throw SyntaxException_init_$Create$('Expected non-link identifier after `as` directive', tmp_1, null, 4, null);
                }
                tmp = tmp_0;
            } else {
                if (!checkIdentifierInImport(RegistryFactory_getInstance(), res._get_left__802434852_d9qyp0_k$())) {
                    throw SyntaxException_init_$Create$('Imports containing folders in name should be declared like:\n`import path as identifier` and used in code with specified identifier', res, null, 4, null);
                }
                var tmp_2 = res._get_children__1387553196_my42wc_k$();
                var tmp_3 = res._get_left__802434852_d9qyp0_k$()._get_symbol__541899891_8ymsmr_k$();
                var tmp_4 = res._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$();
                tmp_2.add_1j60pz_k$(Token_init_$Create$(tmp_3, tmp_4, null, 0, null, null, null, null, 252, null));
                tmp = Unit_getInstance();
            }
            var tmp_5;
            ...
            if (tmp_6 instanceof Link_0) {
                ...
                tmp_5 = checkImportedFolder(tmp_7, tmp_8 instanceof Link_0 ? tmp_8 : THROW_CCE());
            } else {
                if (!checkIdentifierInImport(RegistryFactory_getInstance(), res._get_left__802434852_d9qyp0_k$())) {
                    var tmp_9 = res._get_right__3576132917_bvz45n_k$();
                    throw SyntaxException_init_$Create$('Expected link or identifier before `as` directive', tmp_9, null, 4, null);
                } else {}
            }
            return res;
        };
    ...
    function RegistryFactory$getRegistry$lambda_10() {
        return function(node, parser) {
            ...
            if (expr._get_symbol__541899891_8ymsmr_k$() === ':') {
                res._get_children__1387553196_my42wc_k$().addAll_oxxjjk_k$(expr._get_children__1387553196_my42wc_k$());
                tmp = Unit_getInstance();
            } else {
                var tmp_0 = res._get_children__1387553196_my42wc_k$();
                tmp_0.addAll_oxxjjk_k$(listOf_0([expr, Token_init_$Create$('', '', null, 0, null, null, null, null, 252, null)]));
                tmp = Unit_getInstance();
            }
    ...
    function RegistryFactory$getRegistry$lambda_13() {
        return function(node, parser) {
            var res = new TokenBlock(node);
            Unit_getInstance();
            res._get_children__1387553196_my42wc_k$().addAll_oxxjjk_k$(parser.statements_3k22vw_k$());
            Unit_getInstance();
            parser.advance_fikpbz_k$('}');
            Unit_getInstance();
            return res;
    ...
    function RegistryFactory$getRegistry$lambda_17() {
        return function(node, parser) {
            ...
            Unit_getInstance();
            var tmp;
            if (!(parser._get_lexer__3401167429_es58e3_k$().peek_21nx7_k$()._get_symbol__541899891_8ymsmr_k$() === '}') ? !parser._get_lexer__3401167429_es58e3_k$().peekSeparator_78d6tm_k$() : false) {
                res._get_children__1387553196_my42wc_k$().add_1j60pz_k$(parser.expression_l6myl3_k$(0));
                tmp = Unit_getInstance();
            }
            return res;
    ...
    RegistryFactory.prototype.getRegistry_my6yer_k$ = function() {
        ...
        registry.prefixNud_4q6m7i_k$('false', RegistryFactory$getRegistry$lambda());
        registry.prefixNud_4q6m7i_k$('true', RegistryFactory$getRegistry$lambda_0());
        ...
        registry.infixLed_mn82jz_k$('.', 105, RegistryFactory$getRegistry$lambda_1());
        registry.infixLed_mn82jz_k$('(', 120, RegistryFactory$getRegistry$lambda_2());
        registry.infixLed_mn82jz_k$('[', 110, RegistryFactory$getRegistry$lambda_3());
        registry.prefixNud_4q6m7i_k$('(', RegistryFactory$getRegistry$lambda_4());
        registry.prefixNud_4q6m7i_k$('[', RegistryFactory$getRegistry$lambda_5());
        registry.prefixNud_4q6m7i_k$('{', RegistryFactory$getRegistry$lambda_6());
        registry.prefixNud_4q6m7i_k$('if', RegistryFactory$getRegistry$lambda_7());
        registry.stmt_ai05x1_k$('if', RegistryFactory$getRegistry$lambda_8());
        registry.stmt_ai05x1_k$('import', RegistryFactory$getRegistry$lambda_9());
        registry.stmt_ai05x1_k$('class', RegistryFactory$getRegistry$lambda_10());
        registry.stmt_ai05x1_k$('object', RegistryFactory$getRegistry$lambda_11());
        ...
        registry.stmt_ai05x1_k$('while', RegistryFactory$getRegistry$lambda_14());
        registry.stmt_ai05x1_k$('break', RegistryFactory$getRegistry$lambda_15());
        registry.stmt_ai05x1_k$('continue', RegistryFactory$getRegistry$lambda_16());
        registry.stmt_ai05x1_k$('return', RegistryFactory$getRegistry$lambda_17());
        registry.stmt_ai05x1_k$('#stop', RegistryFactory$getRegistry$lambda_18());
        return registry;
    };
    ...
    function RegistryFactory_getInstance() {
        if (RegistryFactory_instance == null)
            new RegistryFactory();
    ...
    function initializeSuperTypes(superTypes) {
        var tmp$ret$0;
        $l$block: {
            tmp$ret$0 = superTypes._get_entries__31877249_iz8n5_k$().iterator_jk1svi_k$();
            break $l$block;
        }
            ...
            if (tmp2_subject instanceof Identifier) {
                ...
                $l$block_6: {
                    ...
                    $l$block_5: {
                        ...
                        var tmp$ret$3;
                        $l$block_2: {
                            tmp$ret$3 = superTypes._get_entries__31877249_iz8n5_k$().iterator_jk1svi_k$();
                            break $l$block_2;
                        }
                        ...
                        while (tmp0_iterator_1_2.hasNext_bitz1p_k$()) {
                            ...
                            $l$block_4: {
                                var tmp$ret$4;
                                $l$block_3: {
                                    tmp$ret$4 = element_2_3._get_key__857139730_e6bh8y_k$();
                                    break $l$block_3;
                                }
                                var t_5 = tmp$ret$4;
                                tmp$ret$5 = t_5._get_fileTable__504497375_8cd4nz_k$().equals(type._get_fileTable__504497375_8cd4nz_k$()) ? t_5._get_name__804168992_das4rk_k$() === node._get_value__3683422336_a43j40_k$() : false;
                                break $l$block_4;
                            }
                            if (tmp$ret$5) {
                                tmp0_filterTo_0_1.put_3mhbri_k$(element_2_3._get_key__857139730_e6bh8y_k$(), element_2_3._get_value__3683422336_a43j40_k$());
                                Unit_getInstance();
                            } else {}
                        }
                ...
                if (tmp2_subject instanceof Link) {
                    if (!(node._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$() === 2)) {
                        throw PositionalException_init_$Create$('Expected imported file name and type name', node, null, 0, null, 28, null);
                    }
                    var tmp3_elvis_lhs = type._get_fileTable__504497375_8cd4nz_k$().getImportOrNull_hhw2v8_k$(node._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$());
                    var tmp_0;
                    if (tmp3_elvis_lhs == null) {
                        var tmp_1 = node._get_left__802434852_d9qyp0_k$();
                        throw PositionalException_init_$Create$('Import not found', tmp_1, null, 0, null, 28, null);
                    } else {
                    ...
                    $l$block_11: {
                        ...
                        $l$block_10: {
                            ...
                            var tmp$ret$8;
                            $l$block_7: {
                                tmp$ret$8 = superTypes._get_entries__31877249_iz8n5_k$().iterator_jk1svi_k$();
                                break $l$block_7;
                            }
                            ...
                            while (tmp0_iterator_1_2_0.hasNext_bitz1p_k$()) {
                                ...
                                $l$block_9: {
                                    var tmp$ret$9;
                                    $l$block_8: {
                                        tmp$ret$9 = element_2_3_0._get_key__857139730_e6bh8y_k$();
                                        break $l$block_8;
                                    }
                                    var t_5_0 = tmp$ret$9;
                                    tmp$ret$10 = t_5_0._get_fileTable__504497375_8cd4nz_k$().equals(importedFileTable) ? t_5_0._get_name__804168992_das4rk_k$() === node._get_right__3576132917_bvz45n_k$()._get_value__3683422336_a43j40_k$() : false;
                                    break $l$block_9;
                                }
                                if (tmp$ret$10) {
                                    tmp0_filterTo_0_1_0.put_3mhbri_k$(element_2_3_0._get_key__857139730_e6bh8y_k$(), element_2_3_0._get_value__3683422336_a43j40_k$());
                                    Unit_getInstance();
                                } else {}
                            }
                    ...
                    {
                        throw PositionalException_init_$Create$('Expected identifier or link', node, null, 0, null, 28, null);
                    }
                }
            }
            var superType = tmp;
            if (!(superType._get_size__809037418_ddoh9m_k$() === 1)) {
                throw PositionalException_init_$Create$('One super type not found', node, null, 0, null, 28, null);
            }
            type._set_supertype__3811820336_k43hjc_k$(first_0(superType._get_keys__801529559_d97k5z_k$()));
        }
    }

    function analyzeSemantics(startingFileName, roots, nodes) {
        var importGraphCreator = new ImportGraphCreator(startingFileName, nodes, roots);
        importGraphCreator.createGraph_hzqy5d_k$();
        initializeSuperTypes(importGraphCreator._get_supertypes__1291562605_lcyo31_k$());
        var tmp0_iterator = importGraphCreator._get_visitedTables__1623761026_ququ0y_k$().iterator_jk1svi_k$();
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            var fileTable = tmp0_iterator.next_20eer_k$();
            new Analyzer(fileTable);
            Unit_getInstance();
        }
        return first(importGraphCreator._get_visitedTables__1623761026_ququ0y_k$());
    }

    function analyzeType($this, type, fileTable) {
        var table = SymbolTable_init_$Create$(null, type, fileTable, false, 1, null);
        table.addVariable_vmj31f_k$('this', type);
        table.addVariable_vmj31f_k$('parent', type);
        var tmp0_iterator = type._get_assignments__50188043_tvpcb_k$().iterator_jk1svi_k$();
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            var assignment = tmp0_iterator.next_20eer_k$();
            table.addVariableOrNot_1tmm82_k$(assignment._get_left__802434852_d9qyp0_k$());
            Unit_getInstance();
        }
        var tmp1_iterator = type._get_assignments__50188043_tvpcb_k$().iterator_jk1svi_k$();
        while (tmp1_iterator.hasNext_bitz1p_k$()) {
            var assignment_0 = tmp1_iterator.next_20eer_k$();
            changeInvocationType($this, assignment_0, table.copy_1tks5_k$(), true);
        }
        var tmp2_iterator = type._get_functions__2924404246_mnzx7u_k$().iterator_jk1svi_k$();
        while (tmp2_iterator.hasNext_bitz1p_k$()) {
            var function_0 = tmp2_iterator.next_20eer_k$();
            var functionTable = addFunctionParametersToTable($this, function_0, table.copy_1tks5_k$());
            var tmp = function_0._get_body__793495785_d4fd9l_k$();
            changeInvocationType$default($this, tmp, functionTable, false, 8, null);
        }
    }

    function changeInvocationType($this, node, symbolTable, inProperty) {
        var iterator = node._get_children__1387553196_my42wc_k$().iterator_jk1svi_k$();
        var index = 0;
        while (iterator.hasNext_bitz1p_k$()) {
            ...
            if (tmp2_subject instanceof Assignment) {
                symbolTable.addVariableOrNot_1tmm82_k$(child._get_left__802434852_d9qyp0_k$());
                Unit_getInstance();
            } else {
                if (tmp2_subject instanceof Invocation) {
                    if (isInvocation($this, child)) {
                        TokenFactory_getInstance().createSpecificInvocation_ycswry_k$(child, symbolTable, node, index_0);
                        Unit_getInstance();
                    }
                } else {
                    if (tmp2_subject instanceof Link)
        ...
        var tmp3_iterator = node._get_children__1387553196_my42wc_k$().iterator_jk1svi_k$();
        while (tmp3_iterator.hasNext_bitz1p_k$()) {
            var child_0 = tmp3_iterator.next_20eer_k$();
            if (!(child_0 instanceof Link)) {
                changeInvocationType$default($this, child_0, symbolTable, false, 8, null);
            } else {
                {
                    var tmp4_iterator = child_0._get_children__1387553196_my42wc_k$().iterator_jk1svi_k$();
                    while (tmp4_iterator.hasNext_bitz1p_k$()) {
                        var linkChild = tmp4_iterator.next_20eer_k$();
                        changeInvocationType$default($this, linkChild, symbolTable, false, 8, null);
                    }
                }
            }
        }
    ...
    function changeInvocationType$default($this, node, symbolTable, inProperty, $mask0, $handler) {
        if (!(($mask0 & 8) === 0))
            inProperty = false;
    ...
    function changeInvocationsInLink($this, node, symbolTable, inProperty) {
        if (isInvocation($this, node._get_left__802434852_d9qyp0_k$())) {
            TokenFactory_getInstance().createSpecificInvocation_ycswry_k$(node._get_left__802434852_d9qyp0_k$(), symbolTable, node, 0);
            Unit_getInstance();
        }
        if (isInvocation($this, node._get_right__3576132917_bvz45n_k$())) {
            var tmp = node._get_left__802434852_d9qyp0_k$();
            if (tmp instanceof Identifier) {
                TokenFactory_getInstance().changeInvocationOnSecondPositionInLink_vcc4pr_k$(symbolTable, node, inProperty);
                Unit_getInstance();
            } else {
                {
                    node._get_children__1387553196_my42wc_k$().set_meu351_k$(1, new Call(node._get_right__3576132917_bvz45n_k$()));
                    Unit_getInstance();
                    var tmp_0 = node._get_left__802434852_d9qyp0_k$();
                    return changeInvocationType$default($this, tmp_0, symbolTable, false, 8, null);
                }
            }
        }
        var iterator = Utils_getInstance().subList_d3dljg_k$(node._get_children__1387553196_my42wc_k$(), 2).iterator_jk1svi_k$();
        var index = 0;
        while (iterator.hasNext_bitz1p_k$()) {
            var index_0 = index;
            index = index + 1 | 0;
            var child = iterator.next_20eer_k$();
            if (isInvocation($this, child)) {
                node._get_children__1387553196_my42wc_k$().set_meu351_k$(index_0 + 2 | 0, new Call(child));
                Unit_getInstance();
            }
        }
    }
    ...
    function addFunctionParametersToTable($this, function_0, table) {
        var tmp0_iterator = function_0._get_nonDefaultParams__3666398385_ae8evj_k$().iterator_jk1svi_k$();
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            var param = tmp0_iterator.next_20eer_k$();
            table.addVariableOrNot_1tmm82_k$(param);
            Unit_getInstance();
        }
        var tmp1_iterator = function_0._get_defaultParams__1735937674_spj62y_k$().iterator_jk1svi_k$();
        while (tmp1_iterator.hasNext_bitz1p_k$()) {
            var defaultParam = tmp1_iterator.next_20eer_k$();
            changeInvocationType$default($this, defaultParam, table, false, 8, null);
            table.addVariableOrNot_1tmm82_k$(defaultParam._get_left__802434852_d9qyp0_k$());
            Unit_getInstance();
        }
        return table;
    }
    ...
    function Analyzer(fileTable) {
        var tmp0_iterator = plus(fileTable.getTypes_wiwjwj_k$()._get_values__2516944425_tel787_k$(), fileTable.getObjects_aasile_k$()).iterator_jk1svi_k$();
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            var type = tmp0_iterator.next_20eer_k$();
            analyzeType(this, type, fileTable);
        }
        var tmp1_iterator = fileTable.getFunctions_2hetqz_k$().iterator_jk1svi_k$();
        while (tmp1_iterator.hasNext_bitz1p_k$()) {
            var function_0 = tmp1_iterator.next_20eer_k$();
            var table = addFunctionParametersToTable(this, function_0, SymbolTable_init_$Create$(null, null, fileTable, false, 3, null));
            var tmp = function_0._get_body__793495785_d4fd9l_k$();
    ...
    function ImportNode(symbol, value, position, children) {
        Declaration.call(this, symbol, value, position, toMutableList(children));
    }
    ...
    TypeNode.prototype._get_superTypeNode__300917434_4z5pdm_k$ = function() {
        return !(this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(1)._get_value__3683422336_a43j40_k$() === '') ? this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(1) : null;
    };
    TypeNode.$metadata$ = {
        simpleName: 'TypeNode',
        kind: 'class',
    ...
    function Identifier_init_$Create$(value) {
        return Identifier_init_$Init$(value, Object.create(Identifier.prototype));
    }
    ...
    Identifier.prototype.evaluate_hfj3qo_k$ = function(symbolTable) {
        ...
        if (tmp1_elvis_lhs == null) {
            ...
            if (tmp0_elvis_lhs == null) {
                ...
                throw NotFoundException_init_$Create$(this, null, tmp_1, null, 10, null);
            } else {
    ...
    Identifier.prototype.assign_9u530r_k$ = function(assignment, parent, symbolTable, value) {
        if (!(parent == null) ? assignment._get_isProperty__2864475980_nnoe5w_k$() : false) {
    ...
    Identifier.prototype.getFirstUnassigned_yjcem_k$ = function(parent, symbolTable) {
    ...
    function checkNextVariable($this, index, table, initialTable, variable) {
        var tmp0_subject = $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index);
        if (tmp0_subject instanceof Call) {
            var tmp = $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index);
            var tmp_0 = resolveFunctionCall($this, index, table, initialTable, variable, variable.getFunction_cbvgm5_k$(tmp instanceof Call ? tmp : THROW_CCE()))._get_first__3232921377_hkbbvj_k$();
            ...
            if (tmp0_subject instanceof Identifier) {
                ...
                if (tmp_1) {
                    var assignment = variable.getLinkedAssignment_dmryla_k$($this, index);
                    if (!(assignment == null)) {
                        return Optional_init_$Create$(assignment, false, 2, null);
                    }
                } else {}
                var tmp1_elvis_lhs = variable.getPropertyOrNull_191djg_k$($this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index)._get_value__3683422336_a43j40_k$());
                var tmp_2;
                if (tmp1_elvis_lhs == null) {
                ...
                if (tmp0_subject instanceof Index) {
                    var indexToken = $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index)._get_left__802434852_d9qyp0_k$();
                    $l$loop: while (true) {
                        if (!(indexToken instanceof Index)) {
                            break $l$loop;
                        }
                        indexToken = indexToken._get_left__802434852_d9qyp0_k$();
                    }
                    var tmp2_elvis_lhs = variable.getPropertyOrNull_191djg_k$(indexToken._get_value__3683422336_a43j40_k$());
                    if (tmp2_elvis_lhs == null) {
                        if (variable instanceof Type) {
                            var tmp_3 = variable.getAssignment_r8m0ia_k$(indexToken);
                            return Optional_init_$Create$(tmp_3, false, 2, null);
                        } else {
                            {
                                var tmp_4 = indexToken;
                                throw PositionalException_init_$Create$('Property not found', tmp_4, null, 0, null, 28, null);
                            }
                        }
                        Unit_getInstance();
                    } else
                    ...
                    var tmp_6 = $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index);
                    var tmp_7 = tmp_5.toVariable_abd9s8_k$((tmp_6 instanceof Index ? tmp_6 : THROW_CCE()).evaluateIndex_a4vc9c_k$(table), $this._get_right__3576132917_bvz45n_k$()._get_right__3576132917_bvz45n_k$());
                    return Optional_init_$Create$(tmp_7, false, 2, null);
                } else {
                    {
                        var tmp_8 = $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index);
                        throw PositionalException_init_$Create$('Unexpected token', tmp_8, null, 0, null, 28, null);
                    }
                }
            }
        }
    ...
    function checkFirstVariable($this, index, table, initialTable, canBeFile) {
        var tmp0_subject = $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index);
        if (tmp0_subject instanceof Identifier) {
            var identifier = table.getIdentifierOrNull_ua2gmg_k$($this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index));
            var tmp;
            if (identifier == null) {
                var tmp_0;
                if (canBeFile) {
                    ...
                    var nextTable = tmp_1;
                    tmp_0 = checkFirstVariable($this, index + 1 | 0, nextTable, initialTable, false);
                } else {
            ...
            if (tmp0_subject instanceof Call)
                return new Pair(index, resolveFunctionCall($this, index, table, initialTable, null, table.getFunction_cbvgm5_k$($this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index)))._get_first__3232921377_hkbbvj_k$());
            else {
                if (tmp0_subject instanceof Constructor)
                    return new Pair(index, Utils_getInstance().toVariable_abd9s8_k$($this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index).evaluate_hfj3qo_k$(initialTable), $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index)));
                else {
                    {
                        if (!canBeFile) {
                            var tmp_2 = $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index);
                            throw PositionalException_init_$Create$('Unexpected token', tmp_2, null, 0, null, 28, null);
                        }
                        return new Pair(index, Utils_getInstance().toVariable_abd9s8_k$($this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index).evaluate_hfj3qo_k$(table), $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index)));
                    }
                }
            }
        }
    ...
    function checkFirstVariable$default($this, index, table, initialTable, canBeFile, $mask0, $handler) {
        if (!(($mask0 & 16) === 0))
            canBeFile = true;
    ...
    function addFile($this, table) {
        var tmp0_elvis_lhs = table.getImportOrNull_hhw2v8_k$($this._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$());
        var tmp;
        if (tmp0_elvis_lhs == null) {
            return null;
        } else {
    ...
    function resolveFunctionCall($this, index, table, initialTable, currentVariable, function_0) {
        ...
        var tmp2_resolvingType = table._get_resolvingType__1126639278_imrsfi_k$();
        var tableForEvaluation = SymbolTable_init_$Create$(null, tmp1_variableTable, tmp0_fileTable, tmp2_resolvingType, 1, null);
        var tmp_1 = $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index);
        (tmp_1 instanceof Call ? tmp_1 : THROW_CCE()).argumentsToParameters_rkc6j4_k$(function_0, initialTable, tableForEvaluation);
        var tmp_2 = $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index);
        var tmp_3 = tmp_2 instanceof Call ? tmp_2 : THROW_CCE();
        var functionResult = tmp_3.evaluateFunction$default_jzs6o3_k$(tableForEvaluation, function_0, null, 4, null);
        return new Pair(Utils_getInstance().toVariable_abd9s8_k$(functionResult, $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index)), currentVariable);
    }
    ...
    function safeEvaluate($this, parent, symbolTable) {
        ...
        var tmp = table;
        var tmp0_container = checkFirstVariable$default($this, 0, tmp, initialTable, false, 16, null);
        var index = tmp0_container.component1_7eebsc_k$();
        var currentVariable = tmp0_container.component2_7eebsb_k$();
        if (currentVariable == null) {
            var tmp1_elvis_lhs = parent.getAssignment_r8m0ia_k$($this._get_left__802434852_d9qyp0_k$());
            var tmp_0;
            if (tmp1_elvis_lhs == null) {
                var tmp_1 = $this._get_left__802434852_d9qyp0_k$();
                throw PositionalException_init_$Create$('Assignment not found', tmp_1, null, 0, null, 28, null);
            } else {
                tmp_0 = tmp1_elvis_lhs;
            }
        ...
        index = tmp2 + 1 | 0;
        Unit_getInstance();
        while (index < $this._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$()) {
            var res = checkNextVariable($this, index, table, initialTable, ensureNotNull(currentVariable));
            var tmp_2;
            ...
            if (tmp_2)
                return new Tuple4(null, currentVariable, res._get_value__3683422336_a43j40_k$(), index);
            else {}
            ...
            table = table.changeVariable_uoiydg_k$(res._get_value__3683422336_a43j40_k$());
    ...
    Link.prototype.evaluate_hfj3qo_k$ = function(symbolTable) {
        ...
        var tmp0_container = checkFirstVariable$default(this, 0, tmp, symbolTable, false, 16, null);
        var index = tmp0_container.component1_7eebsc_k$();
        var currentVariable = tmp0_container.component2_7eebsb_k$();
        if (currentVariable == null) {
            var tmp_0 = this._get_left__802434852_d9qyp0_k$();
            var tmp_1 = symbolTable.getFileTable_m3scuc_k$();
            throw NotFoundException_init_$Create$(tmp_0, null, tmp_1, null, 10, null);
        }
        table = table.changeVariable_uoiydg_k$(currentVariable);
        var tmp1 = index;
        index = tmp1 + 1 | 0;
        Unit_getInstance();
        while (index < this._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$()) {
            var isResolved = checkNextVariable(this, index, table, symbolTable, ensureNotNull(currentVariable));
    ...
    Link.prototype.assign_9u530r_k$ = function(assignment, parent, symbolTable, value) {
        ...
        if (!(currentParent instanceof Type)) {
            ...
            {
                tmp_2 = !(index === _get_lastIndex__339712501(this._get_children__1387553196_my42wc_k$()));
            }
        }
        if (tmp_2) {
            throw PositionalException_init_$Create$('Link not resolved', null, null, 0, null, 30, null);
        } else {}
        var tmp_3 = this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(_get_lastIndex__339712501(this._get_children__1387553196_my42wc_k$()))._get_value__3683422336_a43j40_k$();
        var tmp_4 = Utils_getInstance();
        var tmp_5 = assignment._get_right__3576132917_bvz45n_k$();
        currentParent.setProperty_tmx3oq_k$(tmp_3, tmp_4.toProperty$default_h4f746_k$(value, tmp_5, null, 2, null));
    };
    Link.prototype.getFirstUnassigned_yjcem_k$ = function(parent, symbolTable) {
        var tmp0_container = this.getFirstUnassignedOrNull$default_1i7ti5_k$(parent, symbolTable, false, 4, null);
        var type = tmp0_container.component1_7eebsc_k$();
        var assignment = tmp0_container.component2_7eebsb_k$();
        if (type == null)
            return new Pair(parent, assignment);
        return new Pair(type, assignment);
    };
    Link.prototype.getFirstUnassignedOrNull_pqyzpa_k$ = function(parent, symbolTable, forLValue) {
        ...
        if (tmp) {
            var tmp_0 = this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index - 1 | 0);
            throw PositionalException_init_$Create$('Expected type', tmp_0, null, 0, null, 28, null);
        } else {}
        if (forLValue ? index === _get_lastIndex__339712501(this._get_children__1387553196_my42wc_k$()) : false)
            return new Pair(parent, null);
        if ((currentVariable == null ? assignment == null : false) ? index < this._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$() : false) {
            var tmp1_elvis_lhs = parent.getLinkedAssignment_dmryla_k$(this, 0);
            var tmp_1;
            if (tmp1_elvis_lhs == null) {
                throw PositionalException_init_$Create$('Assignment not found', null, null, 0, null, 30, null);
            } else {
                tmp_1 = tmp1_elvis_lhs;
            }
            return new Pair(parent, tmp_1);
        }
        return new Pair((currentParent == null ? true : currentParent instanceof Type) ? currentParent : THROW_CCE(), assignment);
    };
    Link.prototype.getFirstUnassignedOrNull$default_1i7ti5_k$ = function(parent, symbolTable, forLValue, $mask0, $handler) {
        if (!(($mask0 & 4) === 0))
            forLValue = false;
        return this.getFirstUnassignedOrNull_pqyzpa_k$(parent, symbolTable, forLValue);
    };
    Link.prototype.getPropertyName_clkepi_k$ = function() {
        var tmp = last(this._get_children__1387553196_my42wc_k$());
        return (isInterface(tmp, Assignable) ? tmp : THROW_CCE()).getPropertyName_clkepi_k$();
    };
    Link.$metadata$ = {
        simpleName: 'Link',
        kind: 'class',
    ...
    function Node_init_$Init$(symbol, value, position, children, $mask0, $marker, $this) {
        if (!(($mask0 & 1) === 0))
            symbol = '';
        if (!(($mask0 & 2) === 0))
            value = '';
    ...
    function Node_init_$Create$(symbol, value, position, children, $mask0, $marker) {
        return Node_init_$Init$(symbol, value, position, children, $mask0, $marker, Object.create(Node.prototype));
    }
    ...
    function Node$traverseUnresolvedOptional$lambda($symbolTable, $parent) {
        return function(it) {
            ...
            if (tmp0_subject instanceof NodeTernary) {
                var condition = it._get_left__802434852_d9qyp0_k$().traverseUnresolvedOptional_s6ax5c_k$($symbolTable, $parent);
                var tmp_0;
                if (condition._get_second__4255435031_njbah_k$() == null) {
                    var tmp_1;
                    if (!equals(it.evaluateCondition_ji1cnt_k$($symbolTable.changeVariable_uoiydg_k$($parent)), 0)) {
                        var result = it._get_right__3576132917_bvz45n_k$().traverseUnresolvedOptional_s6ax5c_k$($symbolTable, $parent);
                        var tmp_2;
                        if (result._get_second__4255435031_njbah_k$() == null) {
                            var tmp_3 = Node_init_$Create$('(LEAVE)', null, null, null, 14, null);
                            tmp_2 = Optional_init_$Create$(tmp_3, false, 2, null);
                        } else {
                            tmp_2 = Optional_init_$Create$(result, false, 2, null);
                        }
                        tmp_1 = tmp_2;
                    } else {
                        var result_0 = it.children_1.get_fkrdnv_k$(2).traverseUnresolvedOptional_s6ax5c_k$($symbolTable, $parent);
                        var tmp_4;
                        if (result_0._get_second__4255435031_njbah_k$() == null) {
                            var tmp_5 = Node_init_$Create$('(LEAVE)', null, null, null, 14, null);
                            tmp_4 = Optional_init_$Create$(tmp_5, false, 2, null);
                        } else {
                            tmp_4 = Optional_init_$Create$(result_0, false, 2, null);
                        }
                        tmp_1 = tmp_4;
                    }
                    tmp_0 = tmp_1;
                ...
                if (isInterface(tmp0_subject, Assignable)) {
                    var result_1 = it.getFirstUnassigned_yjcem_k$($parent, $symbolTable.changeVariable_uoiydg_k$($parent));
                    var tmp_6;
                    if (result_1._get_second__4255435031_njbah_k$() == null) {
                        var tmp_7 = Node_init_$Create$('(LEAVE)', null, null, null, 14, null);
                        tmp_6 = Optional_init_$Create$(tmp_7, false, 2, null);
                    } else {
                        tmp_6 = Optional_init_$Create$(result_1, false, 2, null);
                    }
                    tmp = tmp_6;
                } else {
                    {
    ...
    Node.prototype.toString = function() {
        return this.symbol_1 === this.value_1 ? this.symbol_1 : this.symbol_1 + ':' + this.value_1;
    };
    Node.prototype.evaluate_hfj3qo_k$ = function(symbolTable) {
        throw PositionalException_init_$Create$('Not implemented', this, null, 0, null, 28, null);
    };
    Node.prototype.traverseUntilOptional_kqe059_k$ = function(condition) {
        ...
        if (!(forThis._get_value__3683422336_a43j40_k$() == null)) {
            ...
            if (tmp_1 instanceof Node) {
                tmp_0 = !(forThis._get_value__3683422336_a43j40_k$().symbol_1 === '(LEAVE)');
            } else {
                {
                    tmp_0 = true;
                }
            ...
            while (tmp0_iterator.hasNext_bitz1p_k$()) {
                ...
                if (!(childRes._get_value__3683422336_a43j40_k$() == null)) {
                    ...
                    if (tmp_4 instanceof Node) {
                        tmp_3 = !(childRes._get_value__3683422336_a43j40_k$().symbol_1 === '(LEAVE)');
                    } else {
                        {
                            tmp_3 = true;
                        }
    ...
    Node.prototype.traverseUnresolvedOptional_s6ax5c_k$ = function(symbolTable, parent) {
        var res = this.traverseUntilOptional_kqe059_k$(Node$traverseUnresolvedOptional$lambda(symbolTable, parent));
        var tmp;
    ...
    Node.prototype.equals = function(other) {
        ...
        if (!(this.children_1._get_size__809037418_ddoh9m_k$() === other.children_1._get_size__809037418_ddoh9m_k$()))
            return false;
        ...
        if (inductionVariable <= last)
            do {
                var i = inductionVariable;
                inductionVariable = inductionVariable + 1 | 0;
                areEqual = this.children_1.get_fkrdnv_k$(i).equals(other.children_1.get_fkrdnv_k$(i));
            }
            while (inductionVariable <= last);
        return areEqual;
    };
    ...
    TokenFactory.prototype.createWordToken_g6p633_k$ = function(symbol, value, position, bindingPower, nud, led, std) {
        var tmp0_subject = symbol;
        return this.wordOperators_1.contains_2ehdt1_k$(tmp0_subject) ? new TypeOperator_0(symbol, value, position, bindingPower, nud, led, std) : new TokenIdentifier(symbol, value, position, bindingPower, nud, led, std);
    };
    TokenFactory.prototype.copy_oi75uk_k$ = function(node, childrenStart, childrenNumber) {
        if (node instanceof Assignment) {
            var res = new Assignment(node._get_symbol__541899891_8ymsmr_k$(), node._get_value__3683422336_a43j40_k$(), node._get_position__3188952002_iahqv2_k$(), node._get_children__1387553196_my42wc_k$());
            res._set_isProperty__3775228504_p44z1r_k$(node._get_isProperty__2864475980_nnoe5w_k$());
            return res;
        } else {}
        if (node instanceof Link)
            return new Link(node._get_symbol__541899891_8ymsmr_k$(), node._get_value__3683422336_a43j40_k$(), node._get_position__3188952002_iahqv2_k$(), node._get_children__1387553196_my42wc_k$().subList_d153ha_k$(childrenStart, childrenStart + childrenNumber | 0));
        else {
            {
                throw PositionalException_init_$Create$('Expected assignment or link', node, null, 0, null, 28, null);
            }
        }
    };
    TokenFactory.prototype.copy$default_gvqacf_k$ = function(node, childrenStart, childrenNumber, $mask0, $handler) {
        if (!(($mask0 & 2) === 0))
            childrenStart = 0;
        if (!(($mask0 & 4) === 0))
            childrenNumber = node._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$();
        return this.copy_oi75uk_k$(node, childrenStart, childrenNumber);
    };
    TokenFactory.prototype.createOperator_3irh8_k$ = function(symbol, value, position, bindingPower, nud, led, std) {
        var tmp0_subject = symbol;
        var tmp;
        if (tmp0_subject === '!is') {
            tmp = new TypeOperator_0(symbol, value, position, bindingPower, nud, led, std);
        } else if (tmp0_subject === '(') {
            tmp = new Invocation_0(symbol, value, position, bindingPower, nud, led, std);
        } else if (tmp0_subject === '.') {
            tmp = Link_init_$Create$('(LINK)', value, position, bindingPower, nud, led, std, null, 128, null);
        } else if (tmp0_subject === '=') {
            tmp = Assignment_init_$Create$('(ASSIGNMENT)', value, position, bindingPower, nud, led, std, null, 128, null);
        } else if (((tmp0_subject === ';' ? true : tmp0_subject === '\n') ? true : tmp0_subject === '\r\n') ? true : tmp0_subject === '\r') {
            tmp = Token_init_$Create$('(SEP)', value, position, bindingPower, nud, led, std, null, 128, null);
        } else if (this.nonArithmeticOperators_1.contains_2ehdt1_k$(tmp0_subject)) {
            tmp = new Operator_0(symbol, value, position, bindingPower, nud, led, std);
        } else if (this.arithmeticOperators_1.contains_2ehdt1_k$(tmp0_subject)) {
            tmp = new ArithmeticOperator_0(symbol, value, position, bindingPower, nud, led, std);
        } else {
            tmp = Token_init_$Create$(symbol, value, position, bindingPower, nud, led, std, null, 128, null);
        }
        return tmp;
    };
    TokenFactory.prototype.createSpecificInvocation_ycswry_k$ = function(nodeIdentifier, symbolTable, upperNode, index) {
        if (!(symbolTable.getFunctionOrNull_p690c9_k$(new Call(nodeIdentifier)) == null)) {
            upperNode._get_children__1387553196_my42wc_k$().set_meu351_k$(index, new Call(nodeIdentifier));
            Unit_getInstance();
        } else if (!(symbolTable.getTypeOrNull_4w5z87_k$(nodeIdentifier._get_left__802434852_d9qyp0_k$()) == null)) {
    ...
    TokenFactory.prototype.changeInvocationOnSecondPositionInLink_vcc4pr_k$ = function(symbolTable, link, inProperty) {
        if (((!(symbolTable.getAssignmentOrNull_mvuv6c_k$(link._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$()) == null) ? true : link._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$() === 'this') ? true : !(symbolTable.getVariableOrNull_x0gevv_k$(link._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$()) == null)) ? true : !(symbolTable.getObjectOrNull_vkys4u_k$(link._get_left__802434852_d9qyp0_k$()) == null)) {
            link._get_children__1387553196_my42wc_k$().set_meu351_k$(1, new Call(link._get_right__3576132917_bvz45n_k$()));
            Unit_getInstance();
            var tmp = link._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(1);
            return tmp instanceof Call ? tmp : THROW_CCE();
        }
        var tmp0_elvis_lhs = symbolTable.getImportOrNull_hhw2v8_k$(link._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$());
        var tmp_0;
        if (tmp0_elvis_lhs == null) {
            var tmp_1;
            if (!inProperty) {
                var tmp_2 = link._get_left__802434852_d9qyp0_k$();
                throw PositionalException_init_$Create$('Variable or import not found', tmp_2, null, 0, null, 28, null);
            } else {
                link._get_children__1387553196_my42wc_k$().set_meu351_k$(1, new Call(link._get_right__3576132917_bvz45n_k$()));
                Unit_getInstance();
                var tmp_3 = link._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(1);
        ...
        var fileTable = tmp_0;
        if (!(fileTable.getFunctionOrNull_p690c9_k$(new Call(link._get_right__3576132917_bvz45n_k$())) == null)) {
            link._get_children__1387553196_my42wc_k$().set_meu351_k$(1, new Call(link._get_right__3576132917_bvz45n_k$()));
            Unit_getInstance();
        } else if (!(fileTable.getTypeOrNull_4rmbrt_k$(link._get_right__3576132917_bvz45n_k$()._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$()) == null)) {
            link._get_children__1387553196_my42wc_k$().set_meu351_k$(1, new Constructor(link._get_right__3576132917_bvz45n_k$()));
            Unit_getInstance();
        } else {
            var tmp_4 = 'No class and function found in `' + fileTable._get_fileName__149290628_2gvtdw_k$() + '`';
            var tmp_5 = link._get_right__3576132917_bvz45n_k$();
            throw PositionalException_init_$Create$(tmp_4, tmp_5, null, 0, null, 28, null);
        }
        var tmp_6 = link._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(1);
    ...
    function getParamName($this, index, function_0) {
        var tmp;
        if (_get_lastIndex__339712501(function_0._get_nonDefaultParams__3666398385_ae8evj_k$()) < index) {
            var tmp_0;
            if ((function_0._get_nonDefaultParams__3666398385_ae8evj_k$()._get_size__809037418_ddoh9m_k$() + _get_lastIndex__339712501(function_0._get_defaultParams__1735937674_spj62y_k$()) | 0) < index) {
                var tmp_1 = $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index);
                throw PositionalException_init_$Create$('More arguments than parameters', tmp_1, null, 0, null, 28, null);
            } else {
                tmp_0 = function_0._get_defaultParams__1735937674_spj62y_k$().get_fkrdnv_k$(index - function_0._get_nonDefaultParams__3666398385_ae8evj_k$()._get_size__809037418_ddoh9m_k$() | 0)._get_name__804168992_das4rk_k$();
            }
            tmp = tmp_0;
        } else {
            tmp = function_0._get_nonDefaultParams__3666398385_ae8evj_k$().get_fkrdnv_k$(index)._get_value__3683422336_a43j40_k$();
        }
        return tmp;
    }

    function Call(node) {
        Invocation.call(this, node._get_symbol__541899891_8ymsmr_k$(), node._get_value__3683422336_a43j40_k$(), node._get_position__3188952002_iahqv2_k$(), node._get_children__1387553196_my42wc_k$());
        this._get_children__1387553196_my42wc_k$().clear_j9y8zo_k$();
        this._get_children__1387553196_my42wc_k$().addAll_oxxjjk_k$(node._get_children__1387553196_my42wc_k$());
        Unit_getInstance();
        this.allArgs_1 = this._get_children__1387553196_my42wc_k$().subList_d153ha_k$(1, this._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$());
    }
    ...
    Call.prototype._get_unnamedArgs__3467525108_domyh8_k$ = function() {
        ...
        $l$loop: while (true) {
            var tmp;
            if (i < this._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$()) {
                var tmp_0 = this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(i);
            ...
            res.add_1j60pz_k$(this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(i));
            Unit_getInstance();
            var tmp0 = i;
            i = tmp0 + 1 | 0;
            Unit_getInstance();
    ...
    Call.prototype._get_namedArgs__2678919515_qq5ig5_k$ = function() {
        var tmp = this._get_children__1387553196_my42wc_k$().subList_d153ha_k$(this._get_unnamedArgs__3467525108_domyh8_k$()._get_size__809037418_ddoh9m_k$() + 1 | 0, this._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$());
    ...
    Call.prototype.evaluate_hfj3qo_k$ = function(symbolTable) {
        ...
        var newTable = symbolTable.changeFile_n27o1t_k$(symbolTable.getFileOfFunction_iwsgea_k$(this, function_0)).changeScope_rjxbi4_k$();
        this.argumentsToParameters_rkc6j4_k$(function_0, symbolTable, newTable);
        return this.evaluateFunction$default_jzs6o3_k$(newTable, function_0, null, 4, null);
    };
    Call.prototype.argumentsToParameters_rkc6j4_k$ = function(function_0, argTable, paramTable) {
        var tmp$ret$0;
        $l$block: {
            tmp$ret$0 = LinkedHashMap_init_$Create$();
            break $l$block;
        ...
        var iterator = this._get_unnamedArgs__3467525108_domyh8_k$().iterator_jk1svi_k$();
        var index = 0;
        while (iterator.hasNext_bitz1p_k$()) {
            var index_0 = index;
            index = index + 1 | 0;
            ...
            if (!(assigned.get_1mhr4y_k$(paramName) == null)) {
                throw PositionalException_init_$Create$('Argument already assigned', arg, null, 0, null, 28, null);
            } {
                var tmp0_set_0 = Utils_getInstance().toVariable_abd9s8_k$(arg.evaluate_hfj3qo_k$(argTable), arg);
                assigned.put_3mhbri_k$(paramName, tmp0_set_0);
                Unit_getInstance();
            }
        }
        var tmp2_iterator = this._get_namedArgs__2678919515_qq5ig5_k$().iterator_jk1svi_k$();
        while (tmp2_iterator.hasNext_bitz1p_k$()) {
            var nArg = tmp2_iterator.next_20eer_k$();
            if (!function_0.hasParam_fjo57y_k$(nArg._get_name__804168992_das4rk_k$())) {
                var tmp = 'Parameter with name `' + nArg._get_name__804168992_das4rk_k$() + '` absent';
                throw PositionalException_init_$Create$(tmp, nArg, null, 0, null, 28, null);
            }
            if (!(assigned.get_1mhr4y_k$(nArg._get_name__804168992_das4rk_k$()) == null)) {
                throw PositionalException_init_$Create$('Argument already assigned', nArg, null, 0, null, 28, null);
            } {
                var tmp1_set_0 = nArg._get_name__804168992_das4rk_k$();
                var tmp2_set_0 = Utils_getInstance().toVariable_abd9s8_k$(nArg._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(argTable), nArg);
                assigned.put_3mhbri_k$(tmp1_set_0, tmp2_set_0);
                Unit_getInstance();
            }
        }
        var tmp3_iterator = function_0._get_defaultParams__1735937674_spj62y_k$().iterator_jk1svi_k$();
        while (tmp3_iterator.hasNext_bitz1p_k$()) {
            var defaultParam = tmp3_iterator.next_20eer_k$();
            if (assigned.get_1mhr4y_k$(defaultParam._get_name__804168992_das4rk_k$()) == null) {
                var tmp3_set_0 = defaultParam._get_name__804168992_das4rk_k$();
                var tmp4_set_0 = Utils_getInstance().toVariable_abd9s8_k$(defaultParam._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(paramTable), defaultParam);
                assigned.put_3mhbri_k$(tmp3_set_0, tmp4_set_0);
                Unit_getInstance();
            }
        }
        var tmp4_iterator = function_0._get_nonDefaultParams__3666398385_ae8evj_k$().iterator_jk1svi_k$();
        while (tmp4_iterator.hasNext_bitz1p_k$()) {
            var param = tmp4_iterator.next_20eer_k$();
            if (assigned.get_1mhr4y_k$(param._get_value__3683422336_a43j40_k$()) == null) {
                throw PositionalException_init_$Create$('Parameter not assigned', param, null, 0, paramTable.getFileTable_m3scuc_k$()._get_fileName__149290628_2gvtdw_k$(), 12, null);
            }
        }
        var tmp$ret$1;
        $l$block_0: {
            tmp$ret$1 = assigned._get_entries__31877249_iz8n5_k$().iterator_jk1svi_k$();
            break $l$block_0;
        }
        var tmp5_iterator = tmp$ret$1;
        while (tmp5_iterator.hasNext_bitz1p_k$()) {
            var i = tmp5_iterator.next_20eer_k$();
            paramTable.addVariable_vmj31f_k$(i._get_key__857139730_e6bh8y_k$(), i._get_value__3683422336_a43j40_k$());
        }
    };
    Call.prototype.evaluateFunction_gpoy9q_k$ = function(symbolTable, function_0, argTable) {
    ...
    Call.prototype.evaluateFunction$default_jzs6o3_k$ = function(symbolTable, function_0, argTable, $mask0, $handler) {
        if (!(($mask0 & 4) === 0))
            argTable = null;
        return this.evaluateFunction_gpoy9q_k$(symbolTable, function_0, argTable);
    };
    Call.$metadata$ = {
        simpleName: 'Call',
        kind: 'class',
    ...
    function evaluateType($this, type, symbolTable) {
        ...
        return symbolTable._get_resolvingType__1126639278_imrsfi_k$() ? type : Companion_getInstance_1().resolveTree_tbefwp_k$(type, symbolTable.changeVariable_uoiydg_k$(type).changeScope_rjxbi4_k$());
    }

    function resolveArguments($this, type, symbolTable) {
        var tmp0_iterator = $this._get_children__1387553196_my42wc_k$().subList_d153ha_k$(1, $this._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$()).iterator_jk1svi_k$();
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            var arg = tmp0_iterator.next_20eer_k$();
            if (!(arg instanceof Assignment)) {
                throw PositionalException_init_$Create$('Expected assignment', arg, null, 0, null, 28, null);
            } else {}
            var tmp = arg._get_left__802434852_d9qyp0_k$();
            if (!(tmp instanceof Identifier)) {
                throw PositionalException_init_$Create$('Expected property name', arg, null, 0, null, 28, null);
            } else {}
            type.setProperty_tmx3oq_k$(arg._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$(), Utils_getInstance().toProperty_s7td2_k$(arg._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable), arg._get_left__802434852_d9qyp0_k$(), type));
            type.removeAssignment_c8vby8_k$(arg._get_left__802434852_d9qyp0_k$());
            Unit_getInstance();
        }
    ...
    Invocation.prototype.evaluate_hfj3qo_k$ = function(symbolTable) {
        throw PositionalException_init_$Create$('Invocations should be replaced with Calls or Constructors', this, null, 0, symbolTable.getFileTable_m3scuc_k$()._get_fileName__149290628_2gvtdw_k$(), 12, null);
    };
    Invocation.$metadata$ = {
    ...
    function evaluateDuplicatedOperators($this, first, second, node) {
        ...
        switch (tmp0_subject) {
            ...
            case '%':
                ...
                break;
            default:
                var tmp_0 = 'Operator `' + node._get_symbol__541899891_8ymsmr_k$() + '` not implemented';
    ...
    function evaluateUnaryMinus($this, number) {
        return isDouble(number) ? -numberToDouble(number) : -numberToInt(number) | 0;
    }

    function evaluateNot($this, symbolTable) {
        var res = $this._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable);
        if (isNumber(res))
            return Utils_getInstance().toInt_1vsdtk_k$(equals(res, 0));
        else {}
        throw PositionalException_init_$Create$('! operator applicable to numbers', $this, null, 0, null, 28, null);
    }
    ...
    ArithmeticOperator.prototype.evaluate_hfj3qo_k$ = function(symbolTable) {
        if (this._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$() === 1) {
            var tmp0_subject = this._get_symbol__541899891_8ymsmr_k$();
            var tmp;
            switch (tmp0_subject) {
                case '-':
                    var tmp_0 = this._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable);
                    tmp = evaluateUnaryMinus(this, isNumber(tmp_0) ? tmp_0 : THROW_CCE());
                    break;
                case '!':
                    tmp = evaluateNot(this, symbolTable);
                    break;
                default:
                    throw PositionalException_init_$Create$('no such prefix arithmetic operator', this, null, 0, null, 28, null);
            }
            return tmp;
        }
        var tmp1_subject = this._get_value__3683422336_a43j40_k$();
        if (tmp1_subject === '&&') {
            var a = this._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable);
            if (!isNumber(a)) {
                var tmp_1 = listOf(PrimitiveClasses_getInstance()._get_numberClass__2243734466_xx91dq_k$());
                var tmp_2 = this._get_left__802434852_d9qyp0_k$();
                throw ExpectedTypeException_init_$Create$(tmp_1, tmp_2, a, false, 8, null);
            } else {}
            var tmp_3;
            if (!equals(a, 0)) {
                var b = this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable);
                if (!isNumber(b)) {
                    var tmp_4 = listOf(PrimitiveClasses_getInstance()._get_numberClass__2243734466_xx91dq_k$());
                    var tmp_5 = this._get_right__3576132917_bvz45n_k$();
                    throw ExpectedTypeException_init_$Create$(tmp_4, tmp_5, b, false, 8, null);
                } else {}
                tmp_3 = Utils_getInstance().toInt_1vsdtk_k$(!equals(a, 0) ? !equals(b, 0) : false);
            } else {
                tmp_3 = 0;
            }
            return tmp_3;
        } else if (tmp1_subject === '||') {
            var a_0 = this._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable);
            if (!isNumber(a_0)) {
                var tmp_6 = listOf(PrimitiveClasses_getInstance()._get_numberClass__2243734466_xx91dq_k$());
                var tmp_7 = this._get_left__802434852_d9qyp0_k$();
                throw ExpectedTypeException_init_$Create$(tmp_6, tmp_7, a_0, false, 8, null);
            } else {}
            var tmp_8;
            if (equals(a_0, 0)) {
                var b_0 = this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable);
                if (!isNumber(b_0)) {
                    var tmp_9 = listOf(PrimitiveClasses_getInstance()._get_numberClass__2243734466_xx91dq_k$());
                    var tmp_10 = this._get_right__3576132917_bvz45n_k$();
                    throw ExpectedTypeException_init_$Create$(tmp_9, tmp_10, b_0, false, 8, null);
                } else {}
                tmp_8 = Utils_getInstance().toInt_1vsdtk_k$(!equals(a_0, 0) ? true : !equals(b_0, 0));
            } else {
                tmp_8 = 1;
            }
            return tmp_8;
        }
        var tmp2_container = Utils_getInstance().unifyNumbers_rb9ciy_k$(this._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable), this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable), this);
        var tmp$ret$0;
        $l$block: {
        ...
        switch (tmp3_subject) {
            case '>':
                return Utils_getInstance().toInt_1vsdtk_k$(numberToDouble(a_1) > numberToDouble(b_1));
            case '<':
                return Utils_getInstance().toInt_1vsdtk_k$(numberToDouble(a_1) < numberToDouble(b_1));
            case '>=':
                return Utils_getInstance().toInt_1vsdtk_k$(numberToDouble(a_1) >= numberToDouble(b_1));
    ...
    function getIndexableAndIndex($this, symbolTable) {
        var indexable = symbolTable.getIdentifier_f5yrxq_k$($this._get_left__802434852_d9qyp0_k$());
        var index = Utils_getInstance().toVariable_abd9s8_k$($this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable), $this._get_right__3576132917_bvz45n_k$());
        var tmp;
        ...
        if (tmp)
            return new Pair(indexable, index);
        else {}
        var tmp_0 = listOf_0([getKClass(PArray), PrimitiveClasses_getInstance()._get_numberClass__2243734466_xx91dq_k$()]);
        throw ExpectedTypeException_init_$Create$(tmp_0, $this, null, true, 4, null);
    }
    ...
    function Index$getFirstUnassigned$lambda($parent, $symbolTable) {
        return function(it) {
            ...
            if (isInterface(it, Assignable)) {
                tmp_0 = !(it.getFirstUnassigned_yjcem_k$($parent, $symbolTable)._get_second__4255435031_njbah_k$() == null);
            } else {
                {
                    tmp_0 = false;
                }
    ...
    Index.prototype.evaluateIndex_a4vc9c_k$ = function(symbolTable) {
        var indexed = Utils_getInstance().toVariable_abd9s8_k$(this._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable), this._get_left__802434852_d9qyp0_k$());
        var index = this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable);
        var tmp0_subject = indexed;
        var tmp;
        if (isInterface(tmp0_subject, Indexable)) {
            tmp = indexed.get_6l87w7_k$(index, this._get_right__3576132917_bvz45n_k$());
        } else {
            {
                var tmp_0 = listOf_0([getKClass(PArray), getKClass(PDictionary), getKClass(PString)]);
                throw ExpectedTypeException_init_$Create$(tmp_0, this, this, false, 8, null);
            }
        }
        return tmp;
    };
    Index.prototype.assign_9u530r_k$ = function(assignment, parent, symbolTable, value) {
        if (parent == null ? true : equals(parent.getProperty_3ji6xm_k$(this.getPropertyName_clkepi_k$()), new PInt(0, parent))) {
            ...
            arr.set_1fwgy9_k$(ind, Utils_getInstance().toVariable_abd9s8_k$(value, assignment._get_right__3576132917_bvz45n_k$()), this._get_left__802434852_d9qyp0_k$(), this._get_right__3576132917_bvz45n_k$());
            return Unit_getInstance();
        }
        var property = parent.getProperty_3ji6xm_k$(this.getPropertyName_clkepi_k$());
        if (!isInterface(property, Indexable)) {
            var tmp = listOf_0([getKClass(PArray), getKClass(PDictionary), getKClass(PString)]);
            var tmp_0 = this._get_left__802434852_d9qyp0_k$();
            throw ExpectedTypeException_init_$Create$(tmp, tmp_0, property, false, 8, null);
        } else {}
        var index = this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable);
        if (!isInt(index)) {
            throw PositionalException_init_$Create$('Index is not integer', this, null, 0, null, 28, null);
        }
        property.set_1fwgy9_k$(index, Utils_getInstance().toVariable_abd9s8_k$(this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable), this._get_right__3576132917_bvz45n_k$()), this._get_left__802434852_d9qyp0_k$(), this._get_right__3576132917_bvz45n_k$());
    };
    Index.prototype.getFirstUnassigned_yjcem_k$ = function(parent, symbolTable) {
        var tmp = this._get_left__802434852_d9qyp0_k$();
        var fromAnother = (isInterface(tmp, Assignable) ? tmp : THROW_CCE()).getFirstUnassigned_yjcem_k$(parent, symbolTable);
        if (!(fromAnother._get_second__4255435031_njbah_k$() == null))
            return fromAnother;
        var tmp_0 = this._get_right__3576132917_bvz45n_k$();
        var indexUnassigned = tmp_0.traverseUntilOptional_kqe059_k$(Index$getFirstUnassigned$lambda(parent, symbolTable));
        if (!(indexUnassigned._get_value__3683422336_a43j40_k$() == null)) {
            var tmp_1 = indexUnassigned._get_value__3683422336_a43j40_k$();
            return ((!(tmp_1 == null) ? isInterface(tmp_1, Assignable) : false) ? tmp_1 : THROW_CCE()).getFirstUnassigned_yjcem_k$(parent, symbolTable);
        }
    ...
    function NodeTernary(node) {
        Node.call(this, node._get_symbol__541899891_8ymsmr_k$(), node._get_value__3683422336_a43j40_k$(), node._get_position__3188952002_iahqv2_k$(), node._get_children__1387553196_my42wc_k$());
    }
    NodeTernary.prototype.evaluate_hfj3qo_k$ = function(symbolTable) {
        if (!(this._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$() === 3)) {
            throw PositionalException_init_$Create$('ternary if should have else branch', this, null, 0, null, 28, null);
        }
        var condition = this.evaluateCondition_ji1cnt_k$(symbolTable);
        return !equals(condition, 0) ? this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable) : this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(2).evaluate_hfj3qo_k$(symbolTable);
    };
    NodeTernary.prototype.evaluateCondition_ji1cnt_k$ = function(symbolTable) {
        return this._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable);
    };
    ...
    function plus_1(_this__1828080292, $this, other, node) {
        if (isInterface(_this__1828080292, MutableList)) {
            ...
            if (isInterface(other, MutableList)) {
            ...
            } else {
                {
                    ...
                    var tmp_0 = Utils_getInstance();
                    res_0.add_1j60pz_k$(tmp_0.toVariable$default_x99qtu_k$(other, null, 1, null));
                    Unit_getInstance();
                    tmp = res_0;
                }
            }
        ...
        if (tmp_2) {
            if (isInt(_this__1828080292) ? isInt(other) : false)
                return numberToInt(_this__1828080292) + numberToInt(other) | 0;
            return numberToDouble(_this__1828080292) + numberToDouble(other);
        } else {
            {
                throw PositionalException_init_$Create$('Operator not applicable to operands', node, null, 0, null, 28, null);
            }
        }
    }
    ...
    function eq(_this__1828080292, $this, other) {
        ...
        if (tmp_0)
            return numberToDouble(_this__1828080292.getPValue_berniv_k$()) === numberToDouble(other.getPValue_berniv_k$());
        else {}
        var tmp_1;
        if (isInterface(_this__1828080292, MutableList)) {
        ...
        if (tmp_1) {
            if (!(_this__1828080292._get_size__809037418_ddoh9m_k$() === other._get_size__809037418_ddoh9m_k$()))
                return false;
            var res = true; {
                var tmp0_forEachIndexed_0 = _this__1828080292;
                var index_1 = 0;
                var tmp0_iterator_2 = tmp0_forEachIndexed_0.iterator_jk1svi_k$();
                while (tmp0_iterator_2.hasNext_bitz1p_k$()) {
                    var item_3 = tmp0_iterator_2.next_20eer_k$(); {
                        var tmp1_4 = index_1;
                        index_1 = tmp1_4 + 1 | 0;
                        var tmp1__anonymous__5_4003154334 = checkIndexOverflow(tmp1_4);
                        if (!eq(ensureNotNull(_this__1828080292.get_fkrdnv_k$(tmp1__anonymous__5_4003154334)), $this, ensureNotNull(other.get_fkrdnv_k$(tmp1__anonymous__5_4003154334))))
                            res = false;
                    }
                }
            }
        ...
        if (tmp_2) {
            ...
            var res_0 = true; {
                ...
                var tmp$ret$0;
                $l$block: {
                    tmp$ret$0 = tmp2_forEach_0._get_entries__31877249_iz8n5_k$().iterator_jk1svi_k$();
                    break $l$block;
                }
                ...
                while (tmp0_iterator_1.hasNext_bitz1p_k$()) {
                    var element_2 = tmp0_iterator_1.next_20eer_k$(); {
                        ...
                        $l$block_3: {
                            ...
                            var tmp$ret$3;
                            $l$block_2: {
                                tmp$ret$3 = (isInterface(tmp0_contains_0_6, Map) ? tmp0_contains_0_6 : THROW_CCE()).containsKey_wgk31w_k$(key_4);
                                break $l$block_2;
                            }
                            tmp$ret$4 = tmp$ret$3;
                            break $l$block_3;
                        ...
                        if (!tmp$ret$4)
                            ...
                            $l$block_4: {
                                ...
                                tmp$ret$5 = (isInterface(tmp1_get_0_7, Map) ? tmp1_get_0_7 : THROW_CCE()).get_1mhr4y_k$(key_4);
                                break $l$block_4;
                            }
    ...
    Operator.prototype.evaluate_hfj3qo_k$ = function(symbolTable) {
        ...
        switch (tmp0_subject) {
            case '+':
                tmp = plus_1(this._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable), this, this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable), this);
                break;
            case '==':
                tmp = Utils_getInstance().toInt_1vsdtk_k$(eq(this._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable), this, this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable)));
                break;
            case '!=':
                tmp = Utils_getInstance().toInt_1vsdtk_k$(neq(this._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable), this, this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable)));
                break;
            default:
                var tmp_0 = 'Operator `' + this._get_value__3683422336_a43j40_k$() + '` not implemented';
                throw PositionalException_init_$Create$(tmp_0, this, null, 0, null, 28, null);
        }
        return tmp;
    };
    Operator.$metadata$ = {
    ...
    function evaluateTypeCheck($this, symbolTable) {
        var checked = Utils_getInstance().toVariable_abd9s8_k$($this._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable), $this._get_left__802434852_d9qyp0_k$());
        var tmp0_subject = $this._get_right__3576132917_bvz45n_k$()._get_value__3683422336_a43j40_k$();
        var tmp;
        switch (tmp0_subject) {
            case 'String':
            ...
            default:
                ...
                var type = $this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable);
                var tmp_0;
                var tmp_1;
                var tmp_2;
                ...
                if (tmp_2) {
                    tmp_1 = checked._get_assignments__50188043_tvpcb_k$().isEmpty_y1axqb_k$();
                } else {
                    {
                        tmp_1 = false;
                    }
                ...
                if (tmp_1) {
                    tmp_0 = type.getProperties_k8mbbr_k$().getPValue_berniv_k$().isEmpty_y1axqb_k$();
                } else {
                    {
                        tmp_0 = false;
                    }
                ...
                throw PositionalException_init_$Create$('Expected class instance or primitive as left operator and class name as right operator', $this, null, 0, null, 28, null);
        }
        return tmp;
    }
    ...
    TypeOperator.prototype.evaluate_hfj3qo_k$ = function(symbolTable) {
        ...
        switch (tmp0_subject) {
            case 'is':
                tmp = Utils_getInstance().toInt_1vsdtk_k$(evaluateTypeCheck(this, symbolTable));
                break;
            case '!is':
                tmp = Utils_getInstance().toInt_1vsdtk_k$(!evaluateTypeCheck(this, symbolTable));
                break;
            default:
                throw PositionalException_init_$Create$('unknown word for operator', this, null, 0, null, 28, null);
        }
        return tmp;
    };
    ...
    function Assignment(symbol, value, position, children) {
        ...
        if (!isInterface(tmp, Assignable)) {
            var tmp_0 = this._get_left__802434852_d9qyp0_k$();
            throw PositionalException_init_$Create$('Left operand is not assignable', tmp_0, null, 0, null, 28, null);
        } else {}
        this.parent_1 = null;
        this.isProperty_1 = false;
    }
    Assignment.prototype._set_parent__1403382957_83u8iz_k$ = function(_set____804775014) {
    ...
    Assignment.prototype._set_isProperty__3775228504_p44z1r_k$ = function(_set____804775014) {
    ...
    Assignment.prototype.evaluate_hfj3qo_k$ = function(symbolTable) {
        var value = this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable);
        var tmp = this._get_left__802434852_d9qyp0_k$();
    ...
    Assignment.prototype.getFirstUnassigned_n1eh3i_k$ = function(symbolTable, parent) {
        var tmp = this._get_left__802434852_d9qyp0_k$();
        if (tmp instanceof Link) {
            var tmp_0 = this._get_left__802434852_d9qyp0_k$();
            var leftUnassigned = (tmp_0 instanceof Link ? tmp_0 : THROW_CCE()).getFirstUnassignedOrNull_pqyzpa_k$(parent, symbolTable, true);
            if (!(leftUnassigned._get_second__4255435031_njbah_k$() == null)) {
                return leftUnassigned instanceof Pair ? leftUnassigned : THROW_CCE();
            }
        } else {}
        return this._get_right__3576132917_bvz45n_k$().traverseUnresolvedOptional_s6ax5c_k$(symbolTable, parent);
    };
    Assignment.prototype.assign_bxw09h_k$ = function(parent, symbolTable) {
        parent.removeAssignment_r847vu_k$(this);
        Unit_getInstance();
        var tmp = this._get_left__802434852_d9qyp0_k$();
        (isInterface(tmp, Assignable) ? tmp : THROW_CCE()).assign_9u530r_k$(this, parent, symbolTable, this._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable));
    };
    Assignment.prototype.equals = function(other) {
        if (!(other instanceof Assignment))
            return false;
        else {}
        return this._get_left__802434852_d9qyp0_k$().equals(other._get_left__802434852_d9qyp0_k$());
    };
    ...
    function CycleStatement_initEntries() {
        if (CycleStatement_entriesInitialized)
            return Unit_getInstance();
    ...
    function evaluateCycle($this, symbolTable) {
        ...
        $l$loop_0: while (Utils_getInstance().toBoolean_ur4mj2_k$(condition.evaluate_hfj3qo_k$(symbolTable), condition)) {
    ...
    function evaluateConditional($this, symbolTable) {
        ...
        if (Utils_getInstance().toBoolean_ur4mj2_k$(condition.evaluate_hfj3qo_k$(symbolTable), condition))
            return trueBlock.evaluate_hfj3qo_k$(symbolTable);
        else if ($this._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$() === 3)
            return $this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(2).evaluate_hfj3qo_k$(symbolTable);
        return Unit_getInstance();
    }

    function evaluateBlock($this, symbolTable) {
        var tmp0_iterator = $this._get_children__1387553196_my42wc_k$().iterator_jk1svi_k$();
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            var token = tmp0_iterator.next_20eer_k$();
            if (token instanceof Block) {
                if (token._get_value__3683422336_a43j40_k$() === '{') {
                    throw PositionalException_init_$Create$('Block within a block. Maybe `if`, `else` or `while` was omitted?', token, null, 0, null, 28, null);
                }
            ...
            } else {
                {
                    ...
                    switch (tmp1_subject) {
                        case 'return':
                            return token._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$() === 0 ? Unit_getInstance() : token._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable);
                        case 'break':
                            if (Companion_getInstance().cycles_1 > 0)
                                return CycleStatement_BREAK_getInstance();
                            else {
                                throw PositionalException_init_$Create$('break out of cycle', token, null, 0, null, 28, null);
                            }
                        ...
                        case 'continue':
                            if (Companion_getInstance().cycles_1 > 0)
                                ...
                                throw PositionalException_init_$Create$('continue out of cycle', token, null, 0, null, 28, null);
                            }
    ...
    Block.prototype.evaluate_hfj3qo_k$ = function(symbolTable) {
        ...
        switch (tmp0_subject) {
            ...
            case 'while':
                ...
                break;
            default:
                throw PositionalException_init_$Create$('Not a block', this, null, 0, null, 28, null);
        }
        return tmp;
    };
    Block.$metadata$ = {
    ...
    WordStatement.prototype.evaluate_hfj3qo_k$ = function(symbolTable) {
        ...
        switch (tmp0_subject) {
            case 'while':
                ...
                break;
            case 'return':
                tmp = this._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$() === 0 ? Unit_getInstance() : this._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable);
                break;
            case 'break':
                tmp = Unit_getInstance();
                break;
        ...
        $l$block_1: {
            ...
            $l$block_0: {
                ...
                while (tmp0_iterator_1_2.hasNext_bitz1p_k$()) {
                    ...
                    var tmp$ret$0;
                    $l$block: {
                        tmp$ret$0 = Utils_getInstance().toVariable_abd9s8_k$(item_2_3.evaluate_hfj3qo_k$(symbolTable), item_2_3);
                        break $l$block;
                    }
                    tmp0_mapTo_0_1.add_1j60pz_k$(tmp$ret$0);
                    Unit_getInstance();
    ...
    NodeDictionary.prototype.evaluate_hfj3qo_k$ = function(symbolTable) {
        ...
        $l$block_1: {
            ...
            var tmp$ret$1;
            $l$block_0: {
                var tmp1_associateTo_0_2 = LinkedHashMap_init_$Create$_0(capacity_1);
                ...
                while (tmp0_iterator_1_3.hasNext_bitz1p_k$()) {
                    var element_2_4 = tmp0_iterator_1_3.next_20eer_k$(); {
                        var tmp$ret$0;
                        $l$block: {
                            tmp$ret$0 = new Pair(Utils_getInstance().toVariable_abd9s8_k$(element_2_4._get_left__802434852_d9qyp0_k$().evaluate_hfj3qo_k$(symbolTable), element_2_4._get_left__802434852_d9qyp0_k$()), Utils_getInstance().toVariable_abd9s8_k$(element_2_4._get_right__3576132917_bvz45n_k$().evaluate_hfj3qo_k$(symbolTable), element_2_4._get_right__3576132917_bvz45n_k$()));
                            break $l$block;
                        }
                        var tmp0_plusAssign_0_5 = tmp$ret$0;
                        tmp1_associateTo_0_2.put_3mhbri_k$(tmp0_plusAssign_0_5._get_first__3232921377_hkbbvj_k$(), tmp0_plusAssign_0_5._get_second__4255435031_njbah_k$());
                        Unit_getInstance();
                    }
                }
    ...
    function EmbeddedFunction_init_$Init$(name, args, namedArgs, execute, $mask0, $marker, $this) {
        if (!(($mask0 & 2) === 0)) {
            var tmp$ret$0;
            var tmp$ret$0_0;
            $l$block: {
    ...
    function EmbeddedFunction_init_$Create$(name, args, namedArgs, execute, $mask0, $marker) {
        return EmbeddedFunction_init_$Init$(name, args, namedArgs, execute, $mask0, $marker, Object.create(EmbeddedFunction.prototype));
    }
    ...
    function EmbeddedFunction(name, args, namedArgs, execute) {
        ...
        $l$block_1: {
            var tmp$ret$3;
            $l$block_0: {
                var tmp0_mapTo_0_1 = ArrayList_init_$Create$_0(collectionSizeOrDefault(args, 10));
        ...
        $l$block_4: {
            var tmp$ret$6;
            $l$block_3: {
                var tmp0_mapTo_0_1_0 = ArrayList_init_$Create$_0(collectionSizeOrDefault(namedArgs, 10));
                var tmp0_iterator_1_2_0 = namedArgs.iterator_jk1svi_k$();
                while (tmp0_iterator_1_2_0.hasNext_bitz1p_k$()) {
                    var item_2_3_0 = tmp0_iterator_1_2_0.next_20eer_k$();
                    var tmp$ret$5;
                    $l$block_2: {
                        tmp$ret$5 = Utils_getInstance().parseAssignment_qe0mu7_k$(item_2_3_0);
                        break $l$block_2;
                    }
        ...
        var tmp_0 = tmp$ret$7;
        RFunction.call(this, name, tmp, tmp_0, Node_init_$Create$(null, null, null, null, 15, null));
        this.execute_1 = execute;
    }
    EmbeddedFunction.prototype.executeFunction_v9v8tp_k$ = function(node, symbolTable) {
    ...
    Object_0.prototype.getProperty_3ji6xm_k$ = function(node) {
        ...
        $l$block_2: {
            ...
            $l$block_1: {
                ...
                while (tmp0_iterator_1_1.hasNext_bitz1p_k$()) {
                    ...
                    var tmp$ret$0;
                    $l$block: {
                        tmp$ret$0 = element_2_2._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$() === node._get_value__3683422336_a43j40_k$();
                        break $l$block;
                    }
                    if (tmp$ret$0) {
        ...
        if (!(assignment == null)) {
            ...
            tmp.processAssignment_45d3rd_k$(SymbolTable_init_$Create$(null, null, this._get_fileTable__504497375_8cd4nz_k$(), false, 3, null), mutableListOf([new Pair(this, assignment)]));
            return ensureNotNull(this._get_properties__3765791160_8r22x4_k$().get_1mhr4y_k$(node._get_value__3683422336_a43j40_k$()));
        }
        return new PInt(0, null);
    };
    Object_0.prototype.getPropertyOrNull_191djg_k$ = function(name) {
        if (!(this._get_properties__3765791160_8r22x4_k$().get_1mhr4y_k$(name) == null))
            return ensureNotNull(this._get_properties__3765791160_8r22x4_k$().get_1mhr4y_k$(name));
        var tmp$ret$2;
        $l$block_2: {
            var tmp0_find_0 = this._get_assignments__50188043_tvpcb_k$();
            var tmp$ret$1;
            $l$block_1: {
                ...
                while (tmp0_iterator_1_1.hasNext_bitz1p_k$()) {
                    ...
                    var tmp$ret$0;
                    $l$block: {
                        tmp$ret$0 = element_2_2._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$() === name;
                        break $l$block;
                    }
                    if (tmp$ret$0) {
                        tmp$ret$1 = element_2_2;
    ...
    Object_0.prototype.getFunction_cbvgm5_k$ = function(node) {
        ...
        var tmp;
        if (tmp0_elvis_lhs == null) {
            var tmp_0 = 'Object `' + this._get_name__804168992_das4rk_k$() + '` does not contain function';
            throw PositionalException_init_$Create$(tmp_0, node, null, 0, null, 28, null);
        } else {
            tmp = tmp0_elvis_lhs;
        }
    ...
    Companion_0.prototype.getFunctionOrNull_p6a1z1_k$ = function(call, functions) {
        var tmp$ret$2;
        $l$block_1: {
            var tmp$ret$1;
            $l$block_0: {
                ...
                while (tmp0_iterator_1_2.hasNext_bitz1p_k$()) {
                    ...
                    var tmp$ret$0;
                    $l$block: {
                        tmp$ret$0 = (element_2_3.name_1 === call._get_name__804168992_das4rk_k$()._get_value__3683422336_a43j40_k$() ? element_2_3.nonDefaultParams_1._get_size__809037418_ddoh9m_k$() <= call._get_allArgs__3896514739_6l87yl_k$()._get_size__809037418_ddoh9m_k$() : false) ? (element_2_3.nonDefaultParams_1._get_size__809037418_ddoh9m_k$() + element_2_3.defaultParams_1._get_size__809037418_ddoh9m_k$() | 0) >= call._get_allArgs__3896514739_6l87yl_k$()._get_size__809037418_ddoh9m_k$() : false;
                        break $l$block;
                    }
                    if (tmp$ret$0) {
                        tmp0_filterTo_0_1.add_1j60pz_k$(element_2_3);
            ...
            $l$block_11: {
                ...
                while (tmp0_iterator_1_2_0.hasNext_bitz1p_k$()) {
                    ...
                    $l$block_10: {
                        ...
                        var tmp$ret$3;
                        $l$block_9: {
                            var tmp0_all_0_5 = call._get_namedArgs__2678919515_qq5ig5_k$();
                            var tmp_0;
                            ...
                            var tmp0_iterator_1_6 = tmp0_all_0_5.iterator_jk1svi_k$();
                            while (tmp0_iterator_1_6.hasNext_bitz1p_k$()) {
                                ...
                                $l$block_7: {
                                    var tmp$ret$6;
                                    $l$block_6: {
                                        var tmp0_find_0_4_8 = element_2_3_0.nonDefaultParams_1;
                                        var tmp$ret$5;
                                        $l$block_5: {
                                            var tmp0_iterator_1_1_5_9 = tmp0_find_0_4_8.iterator_jk1svi_k$();
                                            while (tmp0_iterator_1_1_5_9.hasNext_bitz1p_k$()) {
                                                var element_2_2_6_10 = tmp0_iterator_1_1_5_9.next_20eer_k$();
                                                var tmp$ret$4;
                                                $l$block_3: {
                                                    tmp$ret$4 = element_2_2_6_10._get_value__3683422336_a43j40_k$() === element_2_7._get_name__804168992_das4rk_k$();
                                                    break $l$block_3;
                                                }
                                                if (tmp$ret$4) {
                                                    tmp$ret$5 = element_2_2_6_10;
                                                    break $l$block_5;
                                                } else {}
                                            }
                                            tmp$ret$5 = null;
                                    ...
                                    if (!(tmp$ret$6 == null)) {
                                        ...
                                        unnamedArgsRemoved = tmp0_7_11 + 1 | 0;
                                        Unit_getInstance();
                                    } else {}
                                    tmp$ret$7 = element_2_3_0.hasParam_fjo57y_k$(element_2_7._get_name__804168992_das4rk_k$());
                                    break $l$block_7;
                                }
                                if (!tmp$ret$7) {
                                    tmp$ret$3 = false;
                        ...
                        if (tmp$ret$3) {
                            tmp = (element_2_3_0.nonDefaultParams_1._get_size__809037418_ddoh9m_k$() - unnamedArgsRemoved | 0) <= call._get_unnamedArgs__3467525108_domyh8_k$()._get_size__809037418_ddoh9m_k$();
                        } else {
                            {
                                tmp = false;
                            }
        ...
        $l$block_17: {
            ...
            $l$block_15: {
                ...
                tmp$ret$12 = tmp2__anonymous__6_1215738848.defaultParams_1._get_size__809037418_ddoh9m_k$() + tmp2__anonymous__6_1215738848.nonDefaultParams_1._get_size__809037418_ddoh9m_k$() | 0;
                break $l$block_15;
            }
            ...
            do {
                ...
                var tmp$ret$13;
                $l$block_16: {
                    tmp$ret$13 = e_4.defaultParams_1._get_size__809037418_ddoh9m_k$() + e_4.nonDefaultParams_1._get_size__809037418_ddoh9m_k$() | 0;
                    break $l$block_16;
                }
                var v_5 = tmp$ret$13;
    ...
    RFunction.prototype._get_nonDefaultParams__3666398385_ae8evj_k$ = function() {
    ...
    RFunction.prototype.toString = function() {
        return this.name_1 + '(' + joinToString$default(this.nonDefaultParams_1, ',', null, null, 0, null, null, 62, null) + ')';
    };
    RFunction.prototype.equals = function(other) {
        if (this === other)
            return true;
        if (!(other instanceof RFunction))
            return false;
        else {}
        if (!((this.nonDefaultParams_1._get_size__809037418_ddoh9m_k$() + this.defaultParams_1._get_size__809037418_ddoh9m_k$() | 0) === (other.nonDefaultParams_1._get_size__809037418_ddoh9m_k$() + other.defaultParams_1._get_size__809037418_ddoh9m_k$() | 0)))
            return false;
    ...
    RFunction.prototype.hasParam_fjo57y_k$ = function(name) {
        ...
        $l$block_2: {
            ...
            while (tmp0_iterator_1.hasNext_bitz1p_k$()) {
                ...
                var tmp$ret$1;
                $l$block_0: {
                    tmp$ret$1 = element_2._get_value__3683422336_a43j40_k$() === name;
                    break $l$block_0;
                }
                if (tmp$ret$1) {
                    tmp$ret$0 = true;
        ...
        } else {
            {
                ...
                $l$block_6: {
                    ...
                    while (tmp0_iterator_1_0.hasNext_bitz1p_k$()) {
                        ...
                        var tmp$ret$3;
                        $l$block_4: {
                            tmp$ret$3 = element_2_0._get_name__804168992_das4rk_k$() === name;
                            break $l$block_4;
                        }
                        if (tmp$ret$3) {
                            tmp$ret$2 = true;
    ...
    RFunction.prototype.hashCode = function() {
        ...
        result = imul(31, result) + (this.nonDefaultParams_1._get_size__809037418_ddoh9m_k$() + this.defaultParams_1._get_size__809037418_ddoh9m_k$() | 0) | 0;
        return result;
    };
    RFunction.$metadata$ = {
    ...
    function bfs($this, root) {
        ...
        $l$loop: while (true) {
            ...
            var tmp$ret$5;
            $l$block_4: {
                var tmp1_filterIsInstance_0 = current.getProperties_k8mbbr_k$().getPValue_berniv_k$()._get_values__2516944425_tel787_k$();
                var tmp$ret$4;
                $l$block_3: {
                    var tmp0_filterIsInstanceTo_0_1 = ArrayList_init_$Create$();
                    var tmp0_iterator_1_2 = tmp1_filterIsInstance_0.iterator_jk1svi_k$();
                    while (tmp0_iterator_1_2.hasNext_bitz1p_k$()) {
                        var element_2_3 = tmp0_iterator_1_2.next_20eer_k$();
            ...
            $l$block_7: {
                ...
                $l$block_6: {
                    ...
                    while (tmp0_iterator_1_2_0.hasNext_bitz1p_k$()) {
                        ...
                        var tmp$ret$6;
                        $l$block_5: {
                            tmp$ret$6 = !visited.contains_2ehdt1_k$(element_2_3_0);
                            break $l$block_5;
                        }
                        if (tmp$ret$6) {
    ...
    function getInheritedFunctions($this) {
        if (!($this.supertype_1 == null))
            return plus_0(ensureNotNull($this.supertype_1).functions_1, getInheritedFunctions(ensureNotNull($this.supertype_1)));
        var tmp$ret$0;
        $l$block: {
            tmp$ret$0 = emptySet();
            break $l$block;
    ...
    function getInheritedAssignments($this) {
        if (!($this.supertype_1 == null))
            return plus_0(ensureNotNull($this.supertype_1).assignments_1, getInheritedAssignments(ensureNotNull($this.supertype_1)));
        var tmp$ret$0;
        $l$block: {
            tmp$ret$0 = emptySet();
            break $l$block;
    ...
    Companion_1.prototype.resolveTree_tbefwp_k$ = function(root, symbolTable) {
        ...
        $l$loop: do {
                ...
                Unit_getInstance();
                this.processAssignment_45d3rd_k$(symbolTable.changeVariable_uoiydg_k$(parent), stack);
            }
            while (true);
        symbolTable._set_resolvingType__2046672930_t2rfrb_k$(false);
        return root;
    };
    Companion_1.prototype.processAssignment_45d3rd_k$ = function(symbolTable, stack) {
        $l$loop: while (true) {
            var tmp$ret$0;
            $l$block: {
            ...
            var top = unresolved._get_second__4255435031_njbah_k$().getFirstUnassigned_n1eh3i_k$(symbolTable.changeVariable_uoiydg_k$(unresolved._get_first__3232921377_hkbbvj_k$()), unresolved._get_first__3232921377_hkbbvj_k$());
            if (!(top._get_second__4255435031_njbah_k$() == null)) {
                stack.add_1j60pz_k$(top instanceof Pair ? top : THROW_CCE());
                Unit_getInstance();
            } else
                unresolved._get_second__4255435031_njbah_k$().assign_bxw09h_k$(unresolved._get_first__3232921377_hkbbvj_k$(), symbolTable.changeVariable_uoiydg_k$(unresolved._get_first__3232921377_hkbbvj_k$()));
        }
    };
        ...
        $l$block_2: {
            ...
            $l$block_1: {
                ...
                while (tmp0_iterator_1_1.hasNext_bitz1p_k$()) {
                    ...
                    var tmp$ret$0;
                    $l$block: {
                        tmp$ret$0 = element_2_2._get_left__802434852_d9qyp0_k$().equals(node);
                        break $l$block;
                    }
                    if (tmp$ret$0) {
                        tmp$ret$1 = element_2_2;
    ...
    Type.prototype.getLinkedAssignment_dmryla_k$ = function(link, index) {
        var identProperty = this.getAssignment_r8m0ia_k$(link._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(index));
        if (!(identProperty == null))
            return identProperty;
        var inductionVariable = 2;
        var last = link._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$() - index | 0;
        if (inductionVariable <= last)
            do {
                var childrenNumber = inductionVariable;
                inductionVariable = inductionVariable + 1 | 0;
                var searched = TokenFactory_getInstance().copy_oi75uk_k$(link, index, childrenNumber);
    ...
    Type.prototype.getFunctionOrNull_p690c9_k$ = function(node) {
        ...
        return tmp.getFunctionOrNull_p6a1z1_k$(node instanceof Call ? node : THROW_CCE(), plus_0(this.functions_1, getInheritedFunctions(this)));
    };
    ...
    Type.prototype.getProperties_k8mbbr_k$ = function() {
        ...
        $l$block_4: {
            ...
            var tmp$ret$4;
            $l$block_3: {
                var tmp1_mapKeysTo_0_1 = LinkedHashMap_init_$Create$_0(mapCapacity(tmp0_mapKeys_0._get_size__809037418_ddoh9m_k$()));
                var tmp$ret$3;
                $l$block_2: {
                    var tmp0_associateByTo_0_2 = tmp0_mapKeys_0._get_entries__31877249_iz8n5_k$();
                    ...
                    while (tmp0_iterator_1_3.hasNext_bitz1p_k$()) {
                        ...
                        $l$block_0: {
                            var tmp$ret$0;
                            $l$block: {
                                tmp$ret$0 = element_2_4._get_key__857139730_e6bh8y_k$();
                                break $l$block;
                            }
                            var key_6 = tmp$ret$0;
                            var tmp = Utils_getInstance();
                            tmp$ret$1 = tmp.toVariable$default_x99qtu_k$(key_6, null, 1, null);
                            break $l$block_0;
                        }
                        var tmp_0 = tmp$ret$1;
                        var tmp$ret$2;
                        $l$block_1: {
                            tmp$ret$2 = element_2_4._get_value__3683422336_a43j40_k$();
                            break $l$block_1;
                        }
    ...
    Type.prototype.getProperty_3ji6xm_k$ = function(node) {
        ...
        switch (tmp0_subject) {
            ...
            case 'properties':
                ...
                break;
            default:
                var tmp1_elvis_lhs = this.properties_1.get_1mhr4y_k$(node._get_value__3683422336_a43j40_k$());
                tmp = tmp1_elvis_lhs == null ? new PInt(0, this) : tmp1_elvis_lhs;
                break;
        }
        return tmp;
    };
    ...
    Type.prototype.equalToType_r0ad0h_k$ = function(other) {
        var tmp;
        if (this.name_1 === other.name_1 ? this.fileTable_1.equals(other.fileTable_1) : false) {
    ...
    Variable.prototype._set_parent__1403382957_83u8iz_k$ = function(_set____804775014) {
        this.parent_1 = _set____804775014;
    };
    ...
    function compareVariables($this, a, b) {
        ...
        if (a instanceof Type) {
            ...
            {
                return comparePrimitive($this, a instanceof Primitive ? a : THROW_CCE(), b);
            }
        }
        return tmp;
    }
    ...
    function compareType($this, type, variable) {
        ...
        if (tmp)
            return compareValues(type._get_name__804168992_das4rk_k$(), variable._get_name__804168992_das4rk_k$());
        else {}
        ...
        if (tmp0_subject instanceof Object_0) {
            ...
            if (tmp0_subject instanceof Type) {
                tmp_0 = type.equalToType_r0ad0h_k$(variable) ? 0 : compareValues(type._get_name__804168992_das4rk_k$(), variable._get_name__804168992_das4rk_k$());
            } else {
                {
                    tmp_0 = 1;
                }
    ...
    function comparePrimitive($this, primitive, variable) {
        ...
        if (tmp)
            return compareValues(numberToDouble(primitive.getPValue_berniv_k$()), numberToDouble(variable.getPValue_berniv_k$()));
        else {}
        var tmp_0 = primitive.getIndex_wcnjmk_k$();
        if (!(tmp_0 === (variable instanceof Primitive ? variable : THROW_CCE()).getIndex_wcnjmk_k$()))
            return compareValues(primitive.getIndex_wcnjmk_k$(), variable.getIndex_wcnjmk_k$());
        else {}
        var tmp0_subject = variable;
        var tmp_1;
        if (tmp0_subject instanceof PArray) {
            tmp_1 = compareValues((primitive instanceof PArray ? primitive : THROW_CCE()).getPValue_berniv_k$()._get_size__809037418_ddoh9m_k$(), variable.getPValue_berniv_k$()._get_size__809037418_ddoh9m_k$());
        } else {
            if (tmp0_subject instanceof PDictionary) {
                tmp_1 = compareValues((primitive instanceof PDictionary ? primitive : THROW_CCE()).getPValue_berniv_k$()._get_size__809037418_ddoh9m_k$(), variable.getPValue_berniv_k$()._get_size__809037418_ddoh9m_k$());
            } else {
                if (tmp0_subject instanceof PString) {
                    tmp_1 = compareValues((primitive instanceof PString ? primitive : THROW_CCE()).getPValue_berniv_k$(), variable.getPValue_berniv_k$());
                } else {
                    {
                        throw PositionalException_init_$Create$('Non-comparable primitive', null, null, 0, null, 30, null);
                    }
                }
            }
        }
    ...
    function PArray$Companion$initializeArrayProperties$lambda() {
        return function(pr) {
            var tmp = Utils_getInstance();
            var tmp_0 = (pr instanceof PArray ? pr : THROW_CCE()).getPValue_berniv_k$()._get_size__809037418_ddoh9m_k$();
    ...
    function PArray$Companion$initializeEmbeddedArrayFunctions$lambda() {
        return function(token, args) {
            var list = Utils_getInstance().castToArray_aswmrj_k$(ensureNotNull(args.getPropertyOrNull_191djg_k$('this')));
            Unit_getInstance();
            var argument = FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'element', args);
            Unit_getInstance();
            var index = FunctionFactory_getInstance().getInt_p96aqm_k$(token, 'index', args);
            Unit_getInstance();
            var tmp;
            if (index.getPValue_berniv_k$() < 0 ? true : index.getPValue_berniv_k$() > list.getPValue_berniv_k$()._get_size__809037418_ddoh9m_k$()) {
                var tmp_0 = token._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(1);
                throw PositionalException_init_$Create$('Index out of bounds', tmp_0, null, 0, null, 28, null);
            }
            list.getPValue_berniv_k$().add_ydlf05_k$(index.getPValue_berniv_k$(), argument);
            return Unit_getInstance();
        };
    }
    ...
    function PArray$Companion$initializeEmbeddedArrayFunctions$lambda_0() {
        return function(token, args) {
            ...
            if (argument instanceof Primitive) {
                var removed = false;
                var tmp0_iterator = list.getPValue_berniv_k$().iterator_jk1svi_k$();
                $l$loop: while (tmp0_iterator.hasNext_bitz1p_k$()) {
                ...
                {
                    tmp = Utils_getInstance().toInt_1vsdtk_k$(list.getPValue_berniv_k$().remove_8hbkc6_k$(argument));
                }
            }
            return tmp;
        };
    ...
    function PArray$Companion$initializeEmbeddedArrayFunctions$lambda_1() {
        return function(token, args) {
            ...
            var tmp;
            try {
                tmp = list.getPValue_berniv_k$().removeAt_qvpkxi_k$(index.getPValue_berniv_k$());
            } catch ($p) {
                var tmp_0;
                if ($p instanceof IndexOutOfBoundsException) {
                    var tmp_1 = 'index ' + index.getPValue_berniv_k$() + ' out of bounds for length ' + list.getPValue_berniv_k$()._get_size__809037418_ddoh9m_k$();
                    throw PositionalException_init_$Create$(tmp_1, null, null, 0, null, 30, null);
                } else {
                    {
                        throw $p;
                    }
    ...
    function PArray$Companion$initializeEmbeddedArrayFunctions$lambda_2() {
        return function(token, args) {
            var list = Utils_getInstance().castToArray_aswmrj_k$(ensureNotNull(args.getPropertyOrNull_191djg_k$('this')));
            Unit_getInstance();
            var element = FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'element', args);
            Unit_getInstance();
            var tmp;
    ...
    function PArray$Companion$initializeEmbeddedArrayFunctions$lambda_3() {
        return function(token, args) {
            var array = FunctionFactory_getInstance().getArray_kbjem0_k$(token, 'this', args);
            Unit_getInstance();
            var separator = FunctionFactory_getInstance().getString_j9m6y4_k$(token, 'separator', args);
            Unit_getInstance();
            var tmp = array.getPValue_berniv_k$();
            var tmp_0 = separator.getPValue_berniv_k$();
            return joinToString$default(tmp, tmp_0, null, null, 0, null, null, 62, null);
        };
    }
    ...
    function PArray$Companion$initializeEmbeddedArrayFunctions$lambda_5() {
        return function(token, args) {
            var array = FunctionFactory_getInstance().getArray_kbjem0_k$(token, 'this', args);
            Unit_getInstance();
            var desc = FunctionFactory_getInstance().getInt_p96aqm_k$(token, 'desc', args);
            Unit_getInstance();
            var tmp = PArray$Companion$initializeEmbeddedArrayFunctions$lambda$lambda();
    ...
    function PArray$Companion$initializeEmbeddedArrayFunctions$lambda_6() {
        return function(token, args) {
            var array = FunctionFactory_getInstance().getArray_kbjem0_k$(token, 'this', args);
            Unit_getInstance();
            var desc = FunctionFactory_getInstance().getInt_p96aqm_k$(token, 'reverse', args);
            Unit_getInstance();
    ...
    PArray.prototype.get_6l87w7_k$ = function(index, node) {
        if (!isInt(index)) {
            throw PositionalException_init_$Create$('Expected integer as index', node, null, 0, null, 28, null);
        }
        var tmp;
        if ((typeof index === 'number' ? index : THROW_CCE()) < 0) {
            ...
            {
                tmp = index >= this.getPValue_berniv_k$()._get_size__809037418_ddoh9m_k$();
            }
        }
        if (tmp) {
    ...
    PArray.prototype.set_1fwgy9_k$ = function(index, value, nodeIndex, nodeValue) {
        ...
        tmp.set_meu351_k$((index instanceof PInt ? index : THROW_CCE()).getPValue_berniv_k$(), Utils_getInstance().toVariable_abd9s8_k$(value, nodeIndex));
        Unit_getInstance();
    };
    PArray.prototype.toString = function() {
        ...
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            var e = tmp0_iterator.next_20eer_k$();
            res.append_ssq29y_k$((equals(e, this) ? 'this' : toString_0(e)) + ', ');
            Unit_getInstance();
        }
        if (res.toString() === '[')
            return '[]';
        return toString_0(removeRange(res, numberRangeToNumber(_get_lastIndex__339712501_0(res) - 1 | 0, _get_lastIndex__339712501_0(res)))) + new Char(_Char___init__impl__380027157(93));
    };
    ...
    function PDictionary$Companion$initializeDictionaryProperties$lambda() {
        return function(pr) {
            var tmp = Utils_getInstance();
            var tmp_0 = (pr instanceof PDictionary ? pr : THROW_CCE()).getPValue_berniv_k$()._get_size__809037418_ddoh9m_k$();
            return tmp.toProperty$default_h4f746_k$(tmp_0, null, null, 3, null);
        };
    }
    ...
    function PDictionary$Companion$initializeDictionaryProperties$lambda_0() {
        return function(pr) {
            var tmp = Utils_getInstance();
            var tmp_0 = toMutableList((pr instanceof PDictionary ? pr : THROW_CCE()).getPValue_berniv_k$()._get_keys__801529559_d97k5z_k$());
            return tmp.toProperty$default_h4f746_k$(tmp_0, null, null, 3, null);
        };
    }
    ...
    function PDictionary$Companion$initializeDictionaryProperties$lambda_1() {
        return function(pr) {
            var tmp = Utils_getInstance();
            var tmp_0 = toMutableList((pr instanceof PDictionary ? pr : THROW_CCE()).getPValue_berniv_k$()._get_values__2516944425_tel787_k$());
            return tmp.toProperty$default_h4f746_k$(tmp_0, null, null, 3, null);
        };
    }
    ...
    function PDictionary$Companion$initializeDictionaryFunctions$lambda() {
        return function(token, args) {
            var dict = FunctionFactory_getInstance().getDictionary_8h2ghd_k$(token, 'this', args);
            Unit_getInstance();
    ...
    Companion_3.prototype.initializeDictionaryProperties_wmce6g_k$ = function() {
        var tmp$ret$0;
        $l$block: {
            tmp$ret$0 = LinkedHashMap_init_$Create$();
            break $l$block;
        ...
        tmp_0.setProperty_o08ehl_k$(p, 'keys', PDictionary$Companion$initializeDictionaryProperties$lambda_0());
        var tmp_1 = Companion_getInstance_8();
        tmp_1.setProperty_o08ehl_k$(p, 'values', PDictionary$Companion$initializeDictionaryProperties$lambda_1());
    };
    Companion_3.prototype.initializeDictionaryFunctions_qhpk64_k$ = function() {
        var tmp$ret$0;
        $l$block: {
            tmp$ret$0 = LinkedHashMap_init_$Create$();
            break $l$block;
    ...
    PDictionary.prototype.get_6l87w7_k$ = function(index, node) {
        var tmp0_elvis_lhs = this.getPValue_berniv_k$().get_1mhr4y_k$(Utils_getInstance().toVariable_abd9s8_k$(index, node));
        return tmp0_elvis_lhs == null ? new PInt(0, null) : tmp0_elvis_lhs;
    };
    PDictionary.prototype.set_1fwgy9_k$ = function(index, value, nodeIndex, nodeValue) {
        {
            var tmp0_set_0 = this.getPValue_berniv_k$();
            var tmp1_set_0 = Utils_getInstance().toVariable_abd9s8_k$(index, nodeIndex);
            var tmp2_set_0 = Utils_getInstance().toVariable_abd9s8_k$(value, nodeValue);
    ...
    function PDouble$Companion$initializeDoubleProperties$lambda() {
        return function(it) {
            var tmp = Utils_getInstance();
            var tmp_0 = DoubleCompanionObject_getInstance()._get_MIN_VALUE__1378605517_mssatp_k$();
            return tmp.toProperty$default_h4f746_k$(tmp_0, null, null, 3, null);
        };
    }
    ...
    function PDouble$Companion$initializeDoubleProperties$lambda_0() {
        return function(it) {
            var tmp = Utils_getInstance();
            var tmp_0 = DoubleCompanionObject_getInstance()._get_MAX_VALUE__3201573499_i2z81x_k$();
            return tmp.toProperty$default_h4f746_k$(tmp_0, null, null, 3, null);
        };
    }
    ...
    Companion_4.prototype.initializeDoubleProperties_h2jxrx_k$ = function() {
        ...
        var tmp = Companion_getInstance_8();
        tmp.setProperty_o08ehl_k$(d, 'MIN_VALUE', PDouble$Companion$initializeDoubleProperties$lambda());
        var tmp_0 = Companion_getInstance_8();
        tmp_0.setProperty_o08ehl_k$(d, 'MAX_VALUE', PDouble$Companion$initializeDoubleProperties$lambda_0());
    };
    Companion_4.prototype.initializeEmbeddedDoubleFunctions_tdandr_k$ = function() {
        var d = new PDouble(0.0, null);
    };
    ...
    function PInt$Companion$initializeIntProperties$lambda() {
        return function(p) {
            var tmp = Utils_getInstance();
            var tmp_0 = IntCompanionObject_getInstance()._get_MIN_VALUE__1378605517_mssatp_k$();
            return tmp.toProperty$default_h4f746_k$(tmp_0, null, null, 3, null);
        };
    }
    ...
    function PInt$Companion$initializeIntProperties$lambda_0() {
        return function(p) {
            var tmp = Utils_getInstance();
            var tmp_0 = IntCompanionObject_getInstance()._get_MAX_VALUE__3201573499_i2z81x_k$();
            return tmp.toProperty$default_h4f746_k$(tmp_0, null, null, 3, null);
        };
    }
    ...
    Companion_5.prototype.initializeIntProperties_l5apoh_k$ = function() {
        ...
        var tmp = Companion_getInstance_8();
        tmp.setProperty_o08ehl_k$(i, 'MIN_VALUE', PInt$Companion$initializeIntProperties$lambda());
        var tmp_0 = Companion_getInstance_8();
        tmp_0.setProperty_o08ehl_k$(i, 'MAX_VALUE', PInt$Companion$initializeIntProperties$lambda_0());
    };
    ...
    function PNumber$Companion$initializeEmbeddedNumberFunctions$lambda() {
        return function(_anonymous_parameter_0__2695192052, args) {
            var number = Utils_getInstance().castToNumber_n7uin9_k$(ensureNotNull(args.getPropertyOrNull_191djg_k$('this')));
            Unit_getInstance();
            return numberToDouble(number.getPValue_berniv_k$()) >= 0.0 ? number.getPValue_berniv_k$() : Utils_getInstance().unaryMinus_xbl4ze_k$(number.getPValue_berniv_k$());
        };
    }

    function PNumber$Companion$initializeEmbeddedNumberFunctions$lambda_0() {
        return function(token, args) {
            var tmp0_container = Utils_getInstance().unifyPNumbers_mynzfo_k$(ensureNotNull(args.getPropertyOrNull_191djg_k$('this')), FunctionFactory_getInstance().getIdent_dfe2u9_k$(token, 'other', args), token);
            var tmp$ret$0;
            $l$block: {
                tmp$ret$0 = tmp0_container.get_fkrdnv_k$(0);
                break $l$block;
            ...
            if (isInt(number)) {
                ...
                tmp = coerceAtMost_0(tmp_0, typeof other === 'number' ? other : THROW_CCE());
            } else {
                var tmp_1 = typeof number === 'number' ? number : THROW_CCE();
                tmp = coerceAtMost(tmp_1, typeof other === 'number' ? other : THROW_CCE());
            }
            return tmp;
        };
    }
    ...
    function PNumber$Companion$initializeEmbeddedNumberFunctions$lambda_1() {
        return function(token, args) {
            ...
            if (isInt(number)) {
                var tmp_0 = typeof number === 'number' ? number : THROW_CCE();
                tmp = coerceAtLeast(tmp_0, typeof other === 'number' ? other : THROW_CCE());
            } else {
                var tmp_1 = typeof number === 'number' ? number : THROW_CCE();
                tmp = coerceAtLeast_0(tmp_1, typeof other === 'number' ? other : THROW_CCE());
            }
            return tmp;
        };
    }
    ...
    function PNumber$Companion$initializeEmbeddedNumberFunctions$lambda_2() {
        return function(token, args) {
            var number = Utils_getInstance().castToNumber_n7uin9_k$(ensureNotNull(args.getPropertyOrNull_191djg_k$('this')));
            Unit_getInstance();
            var deg = FunctionFactory_getInstance().getNumber_htzifw_k$(token, 'deg', args);
            Unit_getInstance();
            var tmp$ret$0;
            $l$block: {
    ...
    function PNumber$Companion$initializeEmbeddedNumberFunctions$lambda_3() {
        return function(token, args) {
            var number = FunctionFactory_getInstance().getNumber_htzifw_k$(token, 'this', args);
            Unit_getInstance();
            var digits = FunctionFactory_getInstance().getInt_p96aqm_k$(token, 'digits', args);
            Unit_getInstance();
            var tmp;
            if (digits.getPValue_berniv_k$() < 0) {
                ...
                tmp = roundToInt(numberToDouble(number.getPValue_berniv_k$()) / divisor) * divisor;
            } else {
                tmp = round(numberToDouble(number.getPValue_berniv_k$()), digits.getPValue_berniv_k$());
            }
            return tmp;
        };
    }
    ...
    function PNumber$Companion$initializeEmbeddedNumberFunctions$lambda_4() {
        return function(token, args) {
            var number = FunctionFactory_getInstance().getNumber_htzifw_k$(token, 'this', args);
            Unit_getInstance();
            var divisor = FunctionFactory_getInstance().getNumber_htzifw_k$(token, 'divisor', args);
            Unit_getInstance();
            return numberToInt(number.getPValue_berniv_k$()) / numberToInt(divisor.getPValue_berniv_k$()) | 0;
        };
    }
    ...
    Companion_6.prototype.initializeEmbeddedNumberFunctions_y7q5if_k$ = function() {
        var n = new PNumber(0, null);
        var tmp = Companion_getInstance_8();
        tmp.setFunction_9hbg6v_k$(n, EmbeddedFunction_init_$Create$('abs', null, null, PNumber$Companion$initializeEmbeddedNumberFunctions$lambda(), 6, null));
        var tmp_0 = Companion_getInstance_8();
        var tmp_1 = listOf('other');
        tmp_0.setFunction_9hbg6v_k$(n, EmbeddedFunction_init_$Create$('min', tmp_1, null, PNumber$Companion$initializeEmbeddedNumberFunctions$lambda_0(), 4, null));
        var tmp_2 = Companion_getInstance_8();
        var tmp_3 = listOf('other');
        tmp_2.setFunction_9hbg6v_k$(n, EmbeddedFunction_init_$Create$('max', tmp_3, null, PNumber$Companion$initializeEmbeddedNumberFunctions$lambda_1(), 4, null));
        var tmp_4 = Companion_getInstance_8();
        var tmp_5 = listOf('deg');
        tmp_4.setFunction_9hbg6v_k$(n, EmbeddedFunction_init_$Create$('pow', tmp_5, null, PNumber$Companion$initializeEmbeddedNumberFunctions$lambda_2(), 4, null));
        var tmp_6 = Companion_getInstance_8();
        var tmp_7 = listOf('digits = 0');
        tmp_6.setFunction_9hbg6v_k$(n, EmbeddedFunction_init_$Create$('round', null, tmp_7, PNumber$Companion$initializeEmbeddedNumberFunctions$lambda_3(), 2, null));
        var tmp_8 = Companion_getInstance_8();
        var tmp_9 = listOf('divisor');
        tmp_8.setFunction_9hbg6v_k$(n, EmbeddedFunction_init_$Create$('intDivide', tmp_9, null, PNumber$Companion$initializeEmbeddedNumberFunctions$lambda_4(), 4, null));
    };
    ...
    function PString$Companion$initializeStringProperties$lambda() {
        return function(p) {
            var tmp = Utils_getInstance();
            var tmp_0 = (p instanceof PString ? p : THROW_CCE()).getPValue_berniv_k$().length;
            return tmp.toProperty$default_h4f746_k$(tmp_0, null, null, 3, null);
        };
    }
    ...
    function PString$Companion$initializeEmbeddedStringFunctions$lambda() {
        return function(token, args) {
            var string = Utils_getInstance().castToString_p2wdar_k$(ensureNotNull(args.getPropertyOrNull_191djg_k$('this')));
            Unit_getInstance();
            var start = FunctionFactory_getInstance().getInt_p96aqm_k$(token, 'start', args);
            Unit_getInstance();
            var end = FunctionFactory_getInstance().getInt_p96aqm_k$(token, 'end', args);
            Unit_getInstance();
            var tmp$ret$1;
            $l$block_0: {
    ...
    function PString$Companion$initializeEmbeddedStringFunctions$lambda_0() {
        return function(token, args) {
            var string = Utils_getInstance().castToString_p2wdar_k$(ensureNotNull(args.getPropertyOrNull_191djg_k$('this')));
            Unit_getInstance();
            var oldString = FunctionFactory_getInstance().getString_j9m6y4_k$(token, 'oldString', args);
            Unit_getInstance();
            var newString = FunctionFactory_getInstance().getString_j9m6y4_k$(token, 'newString', args);
            Unit_getInstance();
    ...
    function PString$Companion$initializeEmbeddedStringFunctions$lambda_1() {
        return function(_anonymous_parameter_0__2695192052, args) {
            ...
            $l$block: {
                ...
                tmp$ret$0 = toString_0(reversed_0(isCharSequence(tmp0_reversed_0) ? tmp0_reversed_0 : THROW_CCE()));
                break $l$block;
            }
            return tmp$ret$0;
        };
    ...
    Companion_7.prototype.initializeStringProperties_si2tfh_k$ = function() {
        ...
        var tmp = Companion_getInstance_8();
        tmp.setProperty_o08ehl_k$(s, 'size', PString$Companion$initializeStringProperties$lambda());
    };
    Companion_7.prototype.initializeEmbeddedStringFunctions_f93g67_k$ = function() {
        var s = new PString('', null);
        var tmp = Companion_getInstance_8();
        var tmp_0 = listOf('start');
        var tmp_1 = listOf('end = this.size');
        tmp.setFunction_9hbg6v_k$(s, new EmbeddedFunction('substring', tmp_0, tmp_1, PString$Companion$initializeEmbeddedStringFunctions$lambda()));
        var tmp_2 = Companion_getInstance_8();
        var tmp_3 = listOf_0(['oldString', 'newString']);
        tmp_2.setFunction_9hbg6v_k$(s, EmbeddedFunction_init_$Create$('replace', tmp_3, null, PString$Companion$initializeEmbeddedStringFunctions$lambda_0(), 4, null));
        var tmp_4 = Companion_getInstance_8();
        tmp_4.setFunction_9hbg6v_k$(s, EmbeddedFunction_init_$Create$('reversed', null, null, PString$Companion$initializeEmbeddedStringFunctions$lambda_1(), 6, null));
        var tmp_5 = Companion_getInstance_8();
        tmp_5.setFunction_9hbg6v_k$(s, EmbeddedFunction_init_$Create$('lowercase', null, null, PString$Companion$initializeEmbeddedStringFunctions$lambda_2(), 6, null));
        var tmp_6 = Companion_getInstance_8();
        tmp_6.setFunction_9hbg6v_k$(s, EmbeddedFunction_init_$Create$('uppercase', null, null, PString$Companion$initializeEmbeddedStringFunctions$lambda_3(), 6, null));
        var tmp_7 = Companion_getInstance_8();
        tmp_7.setFunction_9hbg6v_k$(s, EmbeddedFunction_init_$Create$('toArray', null, null, PString$Companion$initializeEmbeddedStringFunctions$lambda_4(), 6, null));
    };
    ...
    PString.prototype.get_6l87w7_k$ = function(index, node) {
        if (!isInt(index)) {
            throw PositionalException_init_$Create$('Expected integer', node, null, 0, null, 28, null);
        }
        var tmp;
        if ((typeof index === 'number' ? index : THROW_CCE()) < 0) {
            tmp = true;
    ...
    function formatClassName($this) {
        ...
        $l$block_0: {
            ...
            var tmp0_substring_0 = last(split$default_0(tmp, tmp_0, false, 0, 6, null));
            var tmp$ret$0;
            $l$block: {
                tmp$ret$0 = tmp0_substring_0;
                break $l$block;
    ...
    Companion_8.prototype.setFunction_9hbg6v_k$ = function(primitive, embeddedFunction) {
        this.functions_1.get_fkrdnv_k$(primitive.getIndex_wcnjmk_k$()).add_1j60pz_k$(embeddedFunction);
        Unit_getInstance();
    };
    ...
    Companion_8.prototype.createPrimitive_b3bsnv_k$ = function(value, parent, node) {
    ...
    Primitive.prototype.equals = function(other) {
        ...
        if (!equals(this._get_value__3683422336_a43j40_k$(), other._get_value__3683422336_a43j40_k$()))
            return false;
        return true;
    };
    ...
    Primitive.prototype.getPropertyOrNull_191djg_k$ = function(name) {
        ...
        switch (tmp0_subject) {
            ...
            case 'properties':
                ...
                break;
            default:
                var tmp1_safe_receiver = Companion_getInstance_8().getAllProperties_tzh4vy_k$().get_fkrdnv_k$(this.getIndex_wcnjmk_k$()).get_1mhr4y_k$(name);
                var tmp_0;
                ...
                if (tmp6_elvis_lhs == null) {
                    ...
                    if (2 <= containsArg ? containsArg <= 3 : false) {
                        var tmp2_safe_receiver = Companion_getInstance_8().getAllProperties_tzh4vy_k$().get_fkrdnv_k$(1).get_1mhr4y_k$(name);
                        var tmp_3;
                        if (tmp2_safe_receiver == null) {
                            tmp_3 = null;
                        } else {
                        ...
                        if (tmp4_elvis_lhs == null) {
                            var tmp3_safe_receiver = Companion_getInstance_8().getAllProperties_tzh4vy_k$().get_fkrdnv_k$(0).get_1mhr4y_k$(name);
                            var tmp_5;
                        ...
                        {
                            var tmp5_safe_receiver = Companion_getInstance_8().getAllProperties_tzh4vy_k$().get_fkrdnv_k$(0).get_1mhr4y_k$(name);
                            var tmp_6;
    ...
    Primitive.prototype.getProperties_k8mbbr_k$ = function() {
        var res = toMutableMap(Companion_getInstance_8().getAllProperties_tzh4vy_k$().get_fkrdnv_k$(0));
        var containsArg = this.getIndex_wcnjmk_k$();
        if (2 <= containsArg ? containsArg <= 3 : false)
            res.putAll_mee1c3_k$(Companion_getInstance_8().getAllProperties_tzh4vy_k$().get_fkrdnv_k$(1));
        else {}
        res.putAll_mee1c3_k$(Companion_getInstance_8().getAllProperties_tzh4vy_k$().get_fkrdnv_k$(this.getIndex_wcnjmk_k$()));
        var tmp$ret$4;
        $l$block_3: {
            var tmp$ret$3;
            $l$block_2: {
                var tmp1_mapValuesTo_0_1 = LinkedHashMap_init_$Create$_0(mapCapacity(res._get_size__809037418_ddoh9m_k$()));
                var tmp$ret$2;
                $l$block_1: {
                    var tmp0_associateByTo_0_2 = res._get_entries__31877249_iz8n5_k$();
                    var tmp0_iterator_1_3 = tmp0_associateByTo_0_2.iterator_jk1svi_k$();
                    while (tmp0_iterator_1_3.hasNext_bitz1p_k$()) {
                        var element_2_4 = tmp0_iterator_1_3.next_20eer_k$();
                        var tmp$ret$0;
                        ...
                        var tmp$ret$1;
                        $l$block_0: {
                            tmp$ret$1 = element_2_4._get_value__3683422336_a43j40_k$()(this);
                            break $l$block_0;
                        }
    ...
    Primitive.prototype.getFunctionOrNull_p690c9_k$ = function(node) {
        ...
        var containsArg = this.getIndex_wcnjmk_k$();
        if (2 <= containsArg ? containsArg <= 3 : false) {
            tmp_1 = plus_0(plus_0(Companion_getInstance_8().functions_1.get_fkrdnv_k$(this.getIndex_wcnjmk_k$()), Companion_getInstance_8().functions_1.get_fkrdnv_k$(1)), Companion_getInstance_8().functions_1.get_fkrdnv_k$(0));
        } else {
            {
                tmp_1 = Companion_getInstance_8().functions_1.get_fkrdnv_k$(this.getIndex_wcnjmk_k$());
            }
        }
    ...
    function createAssignmentsAndFunctions($this, node) {
        ...
        var tmp0_iterator = node._get_children__1387553196_my42wc_k$().iterator_jk1svi_k$();
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            var a = tmp0_iterator.next_20eer_k$();
            if (a instanceof Assignment) {
                if (!res.add_1j60pz_k$(a)) {
                    throw PositionalException_init_$Create$('Same property found above', a, null, 0, null, 28, null);
                }
    ...
    function getFromFilesOrNull($this, getValue) {
        ...
        return valuesList._get_size__809037418_ddoh9m_k$() === 1 ? first(valuesList) : null;
    }
    ...
    function checkImports($this, check) {
        ...
        var tmp0_iterator = $this.imports_1._get_values__2516944425_tel787_k$().iterator_jk1svi_k$();
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            var fileTable = tmp0_iterator.next_20eer_k$();
    ...
    function FileTable$getTypeOrNull$lambda($name) {
        return function(it) {
            ...
            $l$block_2: {
                ...
                $l$block_1: {
                    ...
                    while (tmp0_iterator_1_1.hasNext_bitz1p_k$()) {
                        ...
                        var tmp$ret$0;
                        $l$block: {
                            tmp$ret$0 = element_2_2._get_name__804168992_das4rk_k$() === $name;
                            break $l$block;
                        }
                        if (tmp$ret$0) {
                            tmp$ret$1 = element_2_2;
            ...
            return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.copy_1tks5_k$();
        };
    }
    ...
    function FileTable$getFunctionOrNull$lambda($node) {
        return function(fileTable) {
            var tmp = Companion_getInstance_0();
            return tmp.getFunctionOrNull_p6a1z1_k$($node instanceof Call ? $node : THROW_CCE(), fileTable.functions_1);
        };
    }
    ...
    FileTable.prototype.addType_ye6w96_k$ = function(node) {
        ...
        Unit_getInstance();
        var tmp1_iterator = added._get_assignments__50188043_tvpcb_k$().iterator_jk1svi_k$();
        while (tmp1_iterator.hasNext_bitz1p_k$()) {
    ...
    FileTable.prototype.addObject_iiux36_k$ = function(node) {
        var tmp = node._get_left__802434852_d9qyp0_k$();
        if (!(tmp instanceof Identifier)) {
            throw PositionalException_init_$Create$('Object cannot be inherited', node, null, 0, null, 28, null);
        } else {}
        var name = node._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$();
        var tmp0_container = createAssignmentsAndFunctions(this, node._get_right__3576132917_bvz45n_k$());
        var assignments = tmp0_container.component1_7eebsc_k$();
        var functions = tmp0_container.component2_7eebsb_k$();
        var tmp$ret$2;
        $l$block_2: {
        ...
        if (!(tmp$ret$2 == null)) {
            throw PositionalException_init_$Create$('Two objects with same name', node, null, 0, null, 28, null);
        } else {}
        this.objects_1.add_1j60pz_k$(new Object_0(name, assignments, this));
        Unit_getInstance();
        last_0(this.objects_1)._get_functions__2924404246_mnzx7u_k$().addAll_oxxjjk_k$(functions);
        Unit_getInstance();
    };
    FileTable.prototype.addFunction_5sy9lo_k$ = function(function_0) {
        var res = this.functions_1.add_1j60pz_k$(function_0);
        if (!res) {
            var tmp = 'Two functions with same signature (name and number of non-default parameters) `' + function_0 + '` in ' + this.fileName_1;
            throw PositionalException_init_$Create$(tmp, null, null, 0, null, 30, null);
        }
    };
    FileTable.prototype.addImport_wgtzok_k$ = function(importNode, fileTable) {
        ...
        $l$block_3: {
            ...
            $l$block_2: {
                ...
                $l$block_1: {
                    ...
                    var tmp$ret$0;
                    $l$block: {
                        tmp$ret$0 = tmp0_filter_0._get_entries__31877249_iz8n5_k$().iterator_jk1svi_k$();
                        break $l$block;
                    }
                    var tmp0_iterator_1_2 = tmp$ret$0;
                    while (tmp0_iterator_1_2.hasNext_bitz1p_k$()) {
                        ...
                        var tmp$ret$1;
                        $l$block_0: {
                            tmp$ret$1 = element_2_3._get_value__3683422336_a43j40_k$().equals(fileTable);
                            break $l$block_0;
                        }
                        if (tmp$ret$1) {
                            tmp0_filterTo_0_1.put_3mhbri_k$(element_2_3._get_key__857139730_e6bh8y_k$(), element_2_3._get_value__3683422336_a43j40_k$());
        ...
        if (tmp$ret$4) {
            throw PositionalException_init_$Create$('Same import found above', importNode, null, 0, null, 28, null);
        } else {} {
    ...
    FileTable.prototype.getObjectOrNull_5h3942_k$ = function(name) {
        ...
        return (tmp == null ? true : tmp instanceof Object_0) ? tmp : THROW_CCE();
    };
    FileTable.prototype.getFunctionOrNull_p690c9_k$ = function(node) {
        var tmp = getFromFilesOrNull(this, FileTable$getFunctionOrNull$lambda(node));
        return (tmp == null ? true : tmp instanceof RFunction) ? tmp : THROW_CCE();
    };
    ...
    FileTable.prototype.getImport_m6etbe_k$ = function(node) {
        var tmp0_elvis_lhs = this.imports_1.get_1mhr4y_k$(node._get_value__3683422336_a43j40_k$());
        var tmp;
        if (tmp0_elvis_lhs == null) {
            throw PositionalException_init_$Create$('File not found', node, null, 0, null, 28, null);
        } else {
            tmp = tmp0_elvis_lhs;
        }
        return tmp;
    ...
    FileTable.prototype.getMain_18urbl_k$ = function() {
        ...
        $l$block_1: {
            ...
            $l$block_0: {
                ...
                while (tmp0_iterator_1_2.hasNext_bitz1p_k$()) {
                    ...
                    var tmp$ret$0;
                    $l$block: {
                        tmp$ret$0 = element_2_3._get_name__804168992_das4rk_k$() === 'main';
                        break $l$block;
                    }
                    if (tmp$ret$0) {
                        tmp0_filterTo_0_1.add_1j60pz_k$(element_2_3);
        ...
        if (mains._get_size__809037418_ddoh9m_k$() > 1) {
            var tmp_0 = 'Found 2 or more main functions in `' + this.fileName_1 + '`';
            throw PositionalException_init_$Create$(tmp_0, null, null, 0, null, 30, null);
        }
        return first(mains);
    };
    FileTable.prototype.equals = function(other) {
        ...
        if (!(this.fileName_1 === other.fileName_1))
            return false;
        return true;
    };
        ...
        $l$block_1: {
            ...
            $l$block_0: {
                ...
                while (tmp0_iterator_1_3.hasNext_bitz1p_k$()) {
                    ...
                    var tmp$ret$0;
                    $l$block: {
                        tmp$ret$0 = element_2_4._get_name__804168992_das4rk_k$();
                        break $l$block;
                    }
    ...
    FileTable.prototype.getFileOfFunction_iwsgea_k$ = function(node, function_0) {
        var tmp$ret$2;
        $l$block_2: {
        ...
        switch (tmp1_subject) {
            ...
            case 1:
                ...
                break;
            default:
                var tmp_0 = '`' + node + '` is found in files: ' + suitable + '. Specify file.';
                throw PositionalException_init_$Create$(tmp_0, node, null, 0, null, 28, null);
        }
        return tmp;
    };
    ...
    function SymbolTable_init_$Init$(scopeTable, variableTable, fileTable, resolvingType, $mask0, $marker, $this) {
        if (!(($mask0 & 1) === 0))
    ...
    function SymbolTable_init_$Create$(scopeTable, variableTable, fileTable, resolvingType, $mask0, $marker) {
        return SymbolTable_init_$Init$(scopeTable, variableTable, fileTable, resolvingType, $mask0, $marker, Object.create(SymbolTable.prototype));
    }
    ...
    SymbolTable.prototype._set_resolvingType__2046672930_t2rfrb_k$ = function(_set____804775014) {
        this.resolvingType_1 = _set____804775014;
    };
    SymbolTable.prototype._get_resolvingType__1126639278_imrsfi_k$ = function() {
        return this.resolvingType_1;
    };
    SymbolTable.prototype.getFileOfFunction_iwsgea_k$ = function(node, function_0) {
    ...
    SymbolTable.prototype.changeScope_rjxbi4_k$ = function() {
        return SymbolTable_init_$Create$(null, this.variableTable_1, this.fileTable_1, this.resolvingType_1, 1, null);
    };
    SymbolTable.prototype.changeFile_n27o1t_k$ = function(fileTable) {
        var tmp0_safe_receiver = this.scopeTable_1;
        return new SymbolTable(tmp0_safe_receiver == null ? null : tmp0_safe_receiver.copy_1tks5_k$(), this.variableTable_1, fileTable, this.resolvingType_1);
    };
    ...
    SymbolTable.prototype.addVariable_vmj31f_k$ = function(name, value) {
        return ensureNotNull(this.scopeTable_1).addVariable_vmj31f_k$(name, value);
    };
    ...
    SymbolTable.prototype.getType_93e8u9_k$ = function(node) {
        var tmp0_elvis_lhs = this.fileTable_1.getTypeOrNull_4rmbrt_k$(node._get_value__3683422336_a43j40_k$());
        var tmp;
        if (tmp0_elvis_lhs == null) {
            var tmp_0 = 'Type `' + node._get_value__3683422336_a43j40_k$() + '` not found';
            throw PositionalException_init_$Create$(tmp_0, node, null, 0, null, 28, null);
        } else {
            tmp = tmp0_elvis_lhs;
        }
    ...
    SymbolTable.prototype.getFunction_cbvgm5_k$ = function(node) {
        ...
        if (res == null) {
            if (this.variableTable_1 == null) {
                var tmp = 'Function `' + node._get_left__802434852_d9qyp0_k$()._get_value__3683422336_a43j40_k$() + '` not found';
                throw PositionalException_init_$Create$(tmp, node, null, 0, null, 28, null);
            }
            return ensureNotNull(this.variableTable_1).getFunction_cbvgm5_k$(node);
        }
        return res;
    };
    SymbolTable.prototype.getObjectOrNull_vkys4u_k$ = function(node) {
        return this.fileTable_1.getObjectOrNull_5h3942_k$(node._get_value__3683422336_a43j40_k$());
    };
    ...
    SymbolTable.prototype.getFunctionOrNull_p690c9_k$ = function(node) {
        ...
        if (tmp1_elvis_lhs == null) {
            ...
            tmp = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.getFunctionOrNull_p690c9_k$(node);
        } else {
            tmp = tmp1_elvis_lhs;
        }
        return tmp;
    ...
    SymbolTable.prototype.getVariableOrNull_x0gevv_k$ = function(name) {
        var tmp0_safe_receiver = this.scopeTable_1;
        return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.getVariableOrNull_x0gevv_k$(name);
    };
    SymbolTable.prototype.getIdentifier_f5yrxq_k$ = function(node) {
        var tmp0_elvis_lhs = this.getIdentifierOrNull_ua2gmg_k$(node);
        var tmp;
        if (tmp0_elvis_lhs == null) {
            var tmp_0 = 'Identifier `' + node._get_value__3683422336_a43j40_k$() + '` not found in `' + this.fileTable_1 + '`';
            throw PositionalException_init_$Create$(tmp_0, node, null, 0, null, 28, null);
        } else {
            tmp = tmp0_elvis_lhs;
        }
    ...
    SymbolTable.prototype.getIdentifierOrNull_ua2gmg_k$ = function(node) {
        var variable = this.getVariableOrNull_x0gevv_k$(node._get_value__3683422336_a43j40_k$());
        if (!(variable == null))
            return variable;
        var tmp0_safe_receiver = this.variableTable_1;
        var property = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.getPropertyOrNull_191djg_k$(node._get_value__3683422336_a43j40_k$());
        if (!(property == null))
            return property;
    ...
    SymbolTable.prototype.getPropertyOrNull_191djg_k$ = function(name) {
        var tmp0_safe_receiver = this.variableTable_1;
        return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.getPropertyOrNull_191djg_k$(name);
    };
    SymbolTable.prototype.getAssignmentOrNull_mvuv6c_k$ = function(name) {
        ...
        if (tmp instanceof Type) {
            ...
            return (tmp_0 instanceof Type ? tmp_0 : THROW_CCE()).getAssignment_ghhhs2_k$(name);
        } else {}
        return null;
    };
    SymbolTable.prototype.copy_1tks5_k$ = function() {
        var tmp0_safe_receiver = this.scopeTable_1;
        var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.copy_1tks5_k$();
        return new SymbolTable(tmp1_elvis_lhs == null ? new ScopeTable() : tmp1_elvis_lhs, this.variableTable_1, this.fileTable_1, this.resolvingType_1);
    };
    SymbolTable.prototype.addVariableOrNot_1tmm82_k$ = function(node) {
        ...
        if (tmp0_safe_receiver == null) {
            ...
            tmp0_safe_receiver.addVariable_vmj31f_k$(node._get_value__3683422336_a43j40_k$(), Utils_getInstance().toVariable_abd9s8_k$('', node));
            tmp = Unit_getInstance();
        }
        return tmp;
    };
    SymbolTable.prototype.toString = function() {
        var res = StringBuilder_init_$Create$();
        res.append_ssq29y_k$(Companion_getInstance_10().globalFile_1.stringNotation_2r8rar_k$());
        Unit_getInstance();
        var tmp0_iterator = Companion_getInstance_10().imports_1._get_keys__801529559_d97k5z_k$().iterator_jk1svi_k$();
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            var i = tmp0_iterator.next_20eer_k$();
            res.append_ssq29y_k$('\n');
            Unit_getInstance();
            ...
            Unit_getInstance();
            var tmp1_safe_receiver = Companion_getInstance_10().imports_1.get_1mhr4y_k$(i);
            var tmp;
            if (tmp1_safe_receiver == null) {
                tmp = null;
            } else {
            ...
            if (tmp === true) {
                var tmp$ret$4;
                $l$block_3: {
                    var tmp0_map_0 = ensureNotNull(Companion_getInstance_10().imports_1.get_1mhr4y_k$(i));
                    var tmp$ret$3;
                    $l$block_2: {
                        var tmp0_mapTo_0_1 = ArrayList_init_$Create$_0(tmp0_map_0._get_size__809037418_ddoh9m_k$());
                        var tmp$ret$1;
                        $l$block_0: {
                            tmp$ret$1 = tmp0_map_0._get_entries__31877249_iz8n5_k$().iterator_jk1svi_k$();
                            break $l$block_0;
                        }
                        ...
                        while (tmp0_iterator_1_2.hasNext_bitz1p_k$()) {
                            ...
                            var tmp$ret$2;
                            $l$block_1: {
                                tmp$ret$2 = new Pair(item_2_3._get_value__3683422336_a43j40_k$(), item_2_3._get_key__857139730_e6bh8y_k$());
                                break $l$block_1;
                            }
                            tmp0_mapTo_0_1.add_1j60pz_k$(tmp$ret$2);
                            Unit_getInstance();
                ...
                var tmp_0 = tmp$ret$4;
                res.append_ssq29y_k$('\n\timports: ' + joinToString$default(tmp_0, ',', null, null, 0, null, null, 62, null) + '\n');
                Unit_getInstance();
            } else {}
        }
        return res.toString();
    ...
    function ArithmeticOperator_0(symbol, value, position, bindingPower, nud, led, std) {
        Operator_0.call(this, symbol, value, position, bindingPower, nud, led, std);
    }
    ...
    function Assignment_init_$Init$(symbol, value, position, bindingPower, nud, led, std, children, $mask0, $marker, $this) {
        if (!(($mask0 & 1) === 0))
            symbol = '';
        if (!(($mask0 & 4) === 0))
            position = new Pair(0, 0);
        ...
        Assignment_0.call($this, symbol, value, position, bindingPower, nud, led, std, children);
        return $this;
    }

    function Assignment_init_$Create$(symbol, value, position, bindingPower, nud, led, std, children, $mask0, $marker) {
        return Assignment_init_$Init$(symbol, value, position, bindingPower, nud, led, std, children, $mask0, $marker, Object.create(Assignment_0.prototype));
    }

    function Assignment_0(symbol, value, position, bindingPower, nud, led, std, children) {
        Operator_0.call(this, symbol, value, position, bindingPower, nud, led, std);
        this._get_children__1387553196_my42wc_k$().clear_j9y8zo_k$();
        this._get_children__1387553196_my42wc_k$().addAll_oxxjjk_k$(children);
        Unit_getInstance();
    ...
    Assignment_0.prototype.toNode_edekmb_k$ = function() {
        ...
        return new Assignment(tmp, tmp_0, tmp_1, toMutableList(tmp$ret$2));
    };
    ...
    function checkParamsOrArgsOrder($this, params) {
        ...
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            ...
            if (tmp1_subject instanceof Assignment_0)
                wasAssignment = true;
            else {
                if (tmp1_subject instanceof TokenIdentifier) {
                    if (wasAssignment) {
                        throw SyntaxException_init_$Create$('Default params should be after other', param, null, 4, null);
                    }
                } else {
                    if (wasAssignment) {
                        throw SyntaxException_init_$Create$('Named args should be after other', param, null, 4, null);
                    }
                }
            }
        }
    ...
    function Invocation_0(symbol, value, position, bindingPower, nud, led, std) {
        Token_init_$Init$(symbol, value, position, bindingPower, nud, led, std, null, 128, null, this);
    }
    Invocation_0.prototype.toNode_edekmb_k$ = function() {
        checkParamsOrArgsOrder(this, this._get_children__1387553196_my42wc_k$().subList_d153ha_k$(1, this._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$()));
        var tmp = this._get_symbol__541899891_8ymsmr_k$();
        var tmp_0 = this._get_value__3683422336_a43j40_k$();
        var tmp_1 = this._get_position__3188952002_iahqv2_k$();
        var tmp$ret$2;
    ...
    function Link_init_$Init$(symbol, value, position, bindingPower, nud, led, std, children, $mask0, $marker, $this) {
        if (!(($mask0 & 128) === 0)) {
            var tmp$ret$0;
            var tmp$ret$0_0;
            $l$block: {
        ...
        Link_0.call($this, symbol, value, position, bindingPower, nud, led, std, children);
        return $this;
    }

    function Link_init_$Create$(symbol, value, position, bindingPower, nud, led, std, children, $mask0, $marker) {
        return Link_init_$Init$(symbol, value, position, bindingPower, nud, led, std, children, $mask0, $marker, Object.create(Link_0.prototype));
    }

    function Link_0(symbol, value, position, bindingPower, nud, led, std, children) {
        Token_init_$Init$(symbol, value, position, bindingPower, nud, led, std, null, 128, null, this);
        var tmp$ret$1;
        $l$block: {
            tmp$ret$1 = !children.isEmpty_y1axqb_k$();
    ...
    function MetaToken_init_$Init$(symbol, value, position, nud, $mask0, $marker, $this) {
        if (!(($mask0 & 8) === 0)) {
    ...
    function MetaToken_init_$Create$(symbol, value, position, nud, $mask0, $marker) {
        return MetaToken_init_$Init$(symbol, value, position, nud, $mask0, $marker, Object.create(MetaToken.prototype));
    }
    ...
    function MetaToken(symbol, value, position, nud) {
        Token_init_$Init$(symbol, value, position, 0, nud, null, null, null, 232, null, this);
    }
    MetaToken.prototype.toNode_edekmb_k$ = function() {
        return new Meta(this._get_symbol__541899891_8ymsmr_k$(), this._get_value__3683422336_a43j40_k$(), this._get_position__3188952002_iahqv2_k$());
    };
    MetaToken.$metadata$ = {
    ...
    function Token_init_$Init$(symbol, value, position, bindingPower, nud, led, std, children, $mask0, $marker, $this) {
        if (!(($mask0 & 1) === 0))
            symbol = '';
        if (!(($mask0 & 2) === 0))
            value = '';
        ...
        Token.call($this, symbol, value, position, bindingPower, nud, led, std, children);
        return $this;
    }

    function Token_init_$Create$(symbol, value, position, bindingPower, nud, led, std, children, $mask0, $marker) {
        return Token_init_$Init$(symbol, value, position, bindingPower, nud, led, std, children, $mask0, $marker, Object.create(Token.prototype));
    }

    function Token(symbol, value, position, bindingPower, nud, led, std, children) {
        this.symbol_1 = symbol;
        this.value_1 = value;
        this.position_1 = position;
    ...
    Token.prototype._set_symbol__453320063_q2hh9p_k$ = function(_set____804775014) {
        this.symbol_1 = _set____804775014;
    };
    Token.prototype._get_symbol__541899891_8ymsmr_k$ = function() {
        return this.symbol_1;
    };
    Token.prototype._set_value__1325260276_wbpkyq_k$ = function(_set____804775014) {
    ...
    Token.prototype._set_nud__296131368_4rdm8l_k$ = function(_set____804775014) {
        this.nud_1 = _set____804775014;
    };
    Token.prototype._get_nud__857243828_e6dpkk_k$ = function() {
        return this.nud_1;
    };
    Token.prototype._set_led__296056410_ll7hoc_k$ = function(_set____804775014) {
        this.led_1 = _set____804775014;
    };
    Token.prototype._get_led__857168870_e6c3qe_k$ = function() {
        return this.led_1;
    };
    Token.prototype._set_std__296279362_1k36f9_k$ = function(_set____804775014) {
    ...
    Token.prototype.toNode_edekmb_k$ = function() {
        ...
        return Node_init_$Create$(tmp, tmp_0, null, toMutableList(tmp$ret$2), 4, null);
    };
    Token.$metadata$ = {
        simpleName: 'Token',
        kind: 'class',
    ...
    function TokenBlock_init_$Init$(position, $this) {
        TokenBlock.call($this, Token_init_$Create$('{', '{', position, 0, null, null, null, null, 248, null));
        return $this;
    }

    function TokenBlock_init_$Create$(position) {
        return TokenBlock_init_$Init$(position, Object.create(TokenBlock.prototype));
    }
    ...
    function TokenBlock(token) {
        ...
        Token_init_$Init$(tmp, tmp_0, tmp_1, tmp_2, tmp_3, tmp_4, tmp_5, null, 128, null, this);
    }
    ...
    function TokenIdentifier(symbol, value, position, bindingPower, nud, led, std) {
        Token_init_$Init$(symbol, value, position, bindingPower, nud, led, std, null, 128, null, this);
    }
    TokenIdentifier.prototype.toNode_edekmb_k$ = function() {
        return new Identifier(this._get_symbol__541899891_8ymsmr_k$(), this._get_value__3683422336_a43j40_k$(), this._get_position__3188952002_iahqv2_k$());
    };
    ...
    function TokenIndex_init_$Init$(node, $this) {
        TokenIndex.call($this, node._get_symbol__541899891_8ymsmr_k$(), node._get_value__3683422336_a43j40_k$(), node._get_position__3188952002_iahqv2_k$(), node._get_bindingPower__398781387_6lf9or_k$(), node._get_nud__857243828_e6dpkk_k$(), node._get_led__857168870_e6c3qe_k$(), node._get_std__857391822_e6gvri_k$(), node._get_children__1387553196_my42wc_k$());
        return $this;
    }

    function TokenIndex_init_$Create$(node) {
        return TokenIndex_init_$Init$(node, Object.create(TokenIndex.prototype));
    }

    function TokenIndex(symbol, value, position, bindingPower, nud, led, std, children) {
        Token_init_$Init$(symbol, value, position, bindingPower, nud, led, std, null, 128, null, this);
        this._get_children__1387553196_my42wc_k$().clear_j9y8zo_k$();
        this._get_children__1387553196_my42wc_k$().addAll_oxxjjk_k$(children);
        Unit_getInstance();
    ...
    TokenTernary.prototype.toNode_edekmb_k$ = function() {
        ...
        return new NodeTernary(new Node(tmp, tmp_0, tmp_1, toMutableList(tmp$ret$2)));
    };
    ...
    TokenWordStatement.prototype.toNode_edekmb_k$ = function() {
        ...
        return new WordStatement(new Node(tmp, tmp_0, tmp_1, toMutableList(tmp$ret$2)));
    };
    ...
    function TypeOperator_0(symbol, value, position, bindingPower, nud, led, std) {
        Operator_0.call(this, symbol, value, position, bindingPower, nud, led, std);
    }
    ...
    function checkParameters($this, parameters) {
        ...
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
            ...
            if (tmp) {
                throw SyntaxException_init_$Create$('Expected identifier or assignment as function parameter', $this, null, 4, null);
            } else {}
        }
    }

    function TokenFunction(token) {
        Token.call(this, token._get_symbol__541899891_8ymsmr_k$(), token._get_value__3683422336_a43j40_k$(), token._get_position__3188952002_iahqv2_k$(), token._get_bindingPower__398781387_6lf9or_k$(), token._get_nud__857243828_e6dpkk_k$(), token._get_led__857168870_e6c3qe_k$(), token._get_std__857391822_e6gvri_k$(), token._get_children__1387553196_my42wc_k$());
    }
    TokenFunction.prototype.toNode_edekmb_k$ = function() {
        checkParameters(this, this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(0)._get_children__1387553196_my42wc_k$().subList_d153ha_k$(1, this._get_children__1387553196_my42wc_k$().get_fkrdnv_k$(0)._get_children__1387553196_my42wc_k$()._get_size__809037418_ddoh9m_k$()));
        var tmp = this._get_symbol__541899891_8ymsmr_k$();
        var tmp_0 = this._get_value__3683422336_a43j40_k$();
        var tmp_1 = this._get_position__3188952002_iahqv2_k$();
        var tmp$ret$2;
    ...
    function TokenArray(node) {
        Token.call(this, node._get_symbol__541899891_8ymsmr_k$(), node._get_value__3683422336_a43j40_k$(), node._get_position__3188952002_iahqv2_k$(), node._get_bindingPower__398781387_6lf9or_k$(), node._get_nud__857243828_e6dpkk_k$(), node._get_led__857168870_e6c3qe_k$(), node._get_std__857391822_e6gvri_k$(), node._get_children__1387553196_my42wc_k$());
        this._get_children__1387553196_my42wc_k$().clear_j9y8zo_k$();
        this._get_children__1387553196_my42wc_k$().addAll_oxxjjk_k$(this._get_children__1387553196_my42wc_k$());
        Unit_getInstance();
    }
    TokenArray.prototype.toNode_edekmb_k$ = function() {
        ...
        return new NodeArray(new Node(tmp, tmp_0, tmp_1, toMutableList(tmp$ret$2)));
    };
    TokenArray.$metadata$ = {
    ...
    TokenDictionary.prototype.toNode_edekmb_k$ = function() {
        ...
        return new NodeDictionary(new Node(tmp, tmp_0, tmp_1, toMutableList(tmp$ret$2)));
    };
    ...
    function TokenNumber(value, position) {
        ...
        Token_init_$Init$('(NUMBER)', value, position, 0, tmp, null, null, null, 128, null, this);
    }
    TokenNumber.prototype.toNode_edekmb_k$ = function() {
        var tmp;
        if (isInteger(this)) {
            var parsedDouble = toDouble(this._get_value__3683422336_a43j40_k$());
            if (parsedDouble < IntCompanionObject_getInstance()._get_MIN_VALUE__1378605517_mssatp_k$() ? true : parsedDouble > IntCompanionObject_getInstance()._get_MAX_VALUE__3201573499_i2z81x_k$()) {
                var tmp_0 = 'Integer can be in range [' + IntCompanionObject_getInstance()._get_MIN_VALUE__1378605517_mssatp_k$() + ', ' + IntCompanionObject_getInstance()._get_MAX_VALUE__3201573499_i2z81x_k$() + ']';
        ...
        var number = tmp;
        return new NodeNumber(this._get_value__3683422336_a43j40_k$(), this._get_position__3188952002_iahqv2_k$(), number);
    };
    ...
    TokenString.prototype.toNode_edekmb_k$ = function() {
        return new NodeString(this._get_symbol__541899891_8ymsmr_k$(), this._get_value__3683422336_a43j40_k$(), this._get_position__3188952002_iahqv2_k$());
    };
    ...
    Utils.prototype.toBoolean_ur4mj2_k$ = function(_this__1828080292, node) {
        try {
            ...
            if ($p instanceof NumberFormatException) {
                throw PositionalException_init_$Create$('expected numeric value', node, null, 0, null, 28, null);
            } else {
                {
                    throw $p;
                }
    ...
    Utils.prototype.toVariable_abd9s8_k$ = function(_this__1828080292, node) {
        ...
        if (_this__1828080292 instanceof Variable) {
            ...
            {
                tmp = Companion_getInstance_8().createPrimitive_b3bsnv_k$(_this__1828080292, null, node);
            }
        }
        return tmp;
    };
    Utils.prototype.toVariable$default_x99qtu_k$ = function(_this__1828080292, node, $mask0, $handler) {
        if (!(($mask0 & 1) === 0)) {
            node = Node_init_$Create$(null, null, null, null, 15, null);
        }
        return this.toVariable_abd9s8_k$(_this__1828080292, node);
    };
    Utils.prototype.toProperty_s7td2_k$ = function(_this__1828080292, node, parent) {
        var tmp;
        if (_this__1828080292 instanceof Property) {
            tmp = _this__1828080292;
        } else {
            {
                tmp = Companion_getInstance_8().createPrimitive_b3bsnv_k$(_this__1828080292, parent, node);
            }
        }
        return tmp;
    };
    Utils.prototype.toProperty$default_h4f746_k$ = function(_this__1828080292, node, parent, $mask0, $handler) {
        if (!(($mask0 & 1) === 0)) {
            node = Node_init_$Create$(null, null, null, null, 15, null);
        }
        if (!(($mask0 & 2) === 0))
    ...
    Utils.prototype.parseAssignment_qe0mu7_k$ = function(assignment) {
        var tmp = first(Parser_init_$Create$(assignment).statements_3k22vw_k$()).toNode_edekmb_k$();
    ...
    Utils.prototype.unifyPNumbers_mynzfo_k$ = function(first, second, node) {
        ...
        if (first instanceof PNumber) {
            ...
            {
                throw PositionalException_init_$Create$('Expected number', node, null, 0, null, 28, null);
            }
        }
        var firstNumber = tmp;
        var tmp_0;
    ...
    Utils.prototype.unifyNumbers_rb9ciy_k$ = function(first, second, node) {
        if (!isNumber(first)) {
            throw PositionalException_init_$Create$('left operand is not numeric for this infix operator', node, null, 0, null, 28, null);
        } else {}
        if (!isNumber(second)) {
            throw PositionalException_init_$Create$('right operand is not numeric for this infix operator', node, null, 0, null, 28, null);
        } else {}
    ...
    Utils.prototype.unaryMinus_xbl4ze_k$ = function(_this__1828080292) {
        ...
        if (isDouble(_this__1828080292)) {
            tmp = -(typeof _this__1828080292 === 'number' ? _this__1828080292 : THROW_CCE());
        } else {
    ...
    Utils.prototype.subList_d3dljg_k$ = function(_this__1828080292, start) {
        return _this__1828080292.subList_d153ha_k$(start, _this__1828080292._get_size__809037418_ddoh9m_k$());
    };
    Utils.prototype.castToArray_aswmrj_k$ = function(array) {
        if (!(array instanceof PArray)) {
            throw PositionalException_init_$Create$('function in not applicable for this type', null, null, 0, null, 30, null);
        } else {}
        return array;
    };
    ...
    Utils.prototype.castToNumber_n7uin9_k$ = function(num) {
        if (!(num instanceof PNumber)) {
            throw PositionalException_init_$Create$('Expected number', null, null, 0, null, 30, null);
        } else {}
        return num;
    };
    Utils.$metadata$ = {
